...
export async function seedDemoData(
  ...
  await call(api, 'post', `/api/trips/${tripId}/reservations`, {
    ...
    metadata: {
      airline: 'Lufthansa', flight_number: 'LH716',
  ...
  //      one would set the moons_session cookie on it, and extractToken()
  ...
  //     ordinary install shows, and moons_PLUGINS_DEV_LINK additionally reveals a
