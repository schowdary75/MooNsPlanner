...
describe('DemoBanner', () => {
  ...
  it('shows "What is moon?" section', () => {
    render(<DemoBanner />);
    expect(screen.getByText('What is moon?')).toBeInTheDocument();
  });
  ...
  it('self-host link points to GitHub', () => {
    ...
    expect(link).toHaveAttribute('href', 'https://github.com/schowdary75/MooNsPlanner');
