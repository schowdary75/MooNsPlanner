...
const texts: Record<string, DemoTexts> = {
  de: {
    ...
    titleAfter: '',
    title: 'Willkommen zur moon Demo',
    description:
  ...
  en: {
    ...
    titleAfter: '',
    title: 'Welcome to the moon Demo',
  ...
  es: {
    ...
    titleAfter: '',
    title: 'Bienvenido a la demo de moon',
  ...
  ar: {
    ...
    titleAfter: '',
    title: 'مرحبًا بك في النسخة التجريبية من moon',
  ...
  id: {
    ...
    titleAfter: '',
    title: 'Selamat datang di Demo moon',
    description:
    ...
    >
      ...
      >
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 14 }}>
          ...
          >
            {t.titleBefore}
            <img src="/text-dark.svg" alt="moon" style={{ height: 18 }} />
            {t.titleAfter}
          </h2>
        </div>
        ...
        >
          ...
          >
            ...
            <a
              href="https://github.com/schowdary75/MooNsPlanner"
              target="_blank"
