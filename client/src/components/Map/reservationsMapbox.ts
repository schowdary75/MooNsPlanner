...
import { escapeHtml } from '@moons/shared'
import type { Reservation, ReservationEndpoint } from '../../types'

export const RESERVATION_SOURCE_ID = 'moon-reservations'
export const RESERVATION_LINE_LAYER_ID = 'moon-reservations-lines'
...
function buildStatsHtml(mainLabel: string | null, subLabel: string | null): { html: string; width: number; height: number } {
  ...
  const html = `<div class="moon-stats-inner" style="
  ...
  private updateStatsRotation = () => {
    ...
    for (const entry of this.statsMarkers) {
      ...
      try {
        ...
        const inner = el.querySelector('.moon-stats-inner') as HTMLElement | null
