 ...
 * sandboxed PluginFrame; the widget talks to moon only over the bridge.
 *
 ...
 * height the widget reports over moon:resize — no fixed height that would clip a
    ...
    <>
      {plugins.map((p) => (
        ...
        >
          ...
          {/* min-height is just a pre-resize floor; moon:resize drives the real height. */}
