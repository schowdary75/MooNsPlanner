        ...
        >
          ...
          >
            ...
            <div style={{ padding: '20px 24px' }}>
              ...
              {updateInfo?.is_docker === false ? (
                <a
                  href="https://github.com/schowdary75/MooNsPlanner/wiki/Updating"
                  target="_blank"
                ...
                >
                  {`docker pull schowdary75/moon:latest
docker stop moon && docker rm moon
docker run -d --name moon \\
  -p 3000:3000 \\
  -v /opt/moon/data:/app/data \\
  -v /opt/moon/uploads:/app/uploads \\
  --restart unless-stopped \\
  schowdary75/moon:latest`}
                </div>
              )}
