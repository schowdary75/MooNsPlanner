      ...
      <div style={{ maxWidth: 900, margin: '0 auto', padding: '20px 16px' }}>
        ...
        <div style={{ textAlign: 'center', padding: '40px 0 20px' }}>
          ...
          <div className="text-[#d1d5db]" style={{ marginTop: 8, fontSize: 'calc(10px * var(--fs-scale-caption, 1))' }}>
            Made with <span className="text-[#ef4444]">&hearts;</span> by MooN ·{' '}
            <a href="https://github.com/schowdary75/MooNsPlanner" className="text-[#9ca3af]" style={{ textDecoration: 'none' }}>
              GitHub
            </a>
          </div>
        </div>
