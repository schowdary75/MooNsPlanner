    ...
    return (
      <div className="bg-surface" style={{
        ...
        <div style={{ marginBottom: 28 }}>
          <img
            src={document.documentElement.classList.contains('dark') ? '/icons/moon-loading-light.gif' : '/icons/moon-loading-dark.gif'}
            alt="Loading"
            width={64}
            height={64}
          />
            ...
            <div className="hidden md:block" style={{ position: 'absolute', left: 10, top: 10, bottom: 10, zIndex: 20 }}>
              ...
              <div style={{
                ...
                <DayPlanSidebar
                  ...
                  onToggleAllRoutes={() => setAllRoutesShown(v => !v)}
