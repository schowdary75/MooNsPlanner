...
import type { SupportedLanguageCode } from '@moons/shared'
import {
  SUPPORTED_LANGUAGES,
...
const localeLoaders: Record<SupportedLanguageCode, () => Promise<{ default: TranslationStrings }>> = {
  ...
  de:      () => import('@moons/shared/i18n/de'),
  es:      () => import('@moons/shared/i18n/es'),
  fr:      () => import('@moons/shared/i18n/fr'),
  hu:      () => import('@moons/shared/i18n/hu'),
  it:      () => import('@moons/shared/i18n/it'),
  tr:      () => import('@moons/shared/i18n/tr'),
  ru:      () => import('@moons/shared/i18n/ru'),
  zh:      () => import('@moons/shared/i18n/zh'),
  'zh-TW': () => import('@moons/shared/i18n/zh-TW'),
  nl:      () => import('@moons/shared/i18n/nl'),
  id:      () => import('@moons/shared/i18n/id'),
  ar:      () => import('@moons/shared/i18n/ar'),
  br:      () => import('@moons/shared/i18n/br'),
  cs:      () => import('@moons/shared/i18n/cs'),
  pl:      () => import('@moons/shared/i18n/pl'),
  ja:      () => import('@moons/shared/i18n/ja'),
  ko:      () => import('@moons/shared/i18n/ko'),
  uk:      () => import('@moons/shared/i18n/uk'),
  gr:      () => import('@moons/shared/i18n/gr'),
  sv:      () => import('@moons/shared/i18n/sv'),
  vi:      () => import('@moons/shared/i18n/vi'),
  ca:      () => import('@moons/shared/i18n/ca'),
}
