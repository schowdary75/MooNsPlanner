import { normalizeAppearance, type AppearanceConfig } from '@moons/shared'
 ...
 * byte-identical to moon before this feature existed.
 *
...
export const APPEARANCE_SNAPSHOT_KEY = 'moon_appearance'
