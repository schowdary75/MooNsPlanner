 ...
 * plugins and reports whether the runtime is enabled (moons_PLUGINS_ENABLED).
 */
...
const { testDb } = vi.hoisted(() => {
  ...
  db.exec(`CREATE TABLE plugins (
    ...
    moons_range TEXT, sort_order INTEGER DEFAULT 0);
...
describe('PluginsService.list', () => {
  ...
  it('reports disabled when the kill switch is off (moons_PLUGINS_ENABLED=false)', () => {
