...
function seedAdminAccount(db: Database.Database): void {
  try {
    ...
    // Demo mode seeds its own admin (admin@moon.app, username 'admin') right after this.
    ...
    if (isOidcOnlyConfigured()) {
      console.log('');
      console.log('╔══════════════════════════════════════════════╗');
      console.log('║  moon — OIDC-Only Mode                       ║');
    ...
    if (env_admin_email && env_admin_pw) {
      ...
      if (adminEnvProvided) {
        console.warn('[admin] Only one of ADMIN_EMAIL/ADMIN_PASSWORD is set — both are required for a custom admin. Falling back to admin@moon.local with a generated password (shown below).');
      }
    ...
    console.log('');
    console.log('╔══════════════════════════════════════════════╗');
    console.log('║  moon — First Run: Admin Account Created     ║');
    console.log('╠══════════════════════════════════════════════╣');
