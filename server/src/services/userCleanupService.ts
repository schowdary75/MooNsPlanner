 ...
 *     tokens, in-flight OAuth state) — deleted directly; these live in moon.db, not in
 ...
 * moon_PLUGINS_ENABLED=false or before the runtime has booted — otherwise a deletion in
