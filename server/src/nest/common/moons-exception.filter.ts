...
/**
 * Normalises every Nest exception to MooNs's legacy error envelope so migrated
 ...
 */
@Catch()
export class MoonsExceptionFilter implements ExceptionFilter {
    ...
    if (exception instanceof HttpException) {
      ...
      if (body && typeof body === 'object') {
        ...
        // moons-native shape ({ error } / { error, code } from guards + the Zod
