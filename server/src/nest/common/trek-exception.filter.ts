...
/**
 * Normalises every Nest exception to moon's legacy error envelope so migrated
 ...
 */
@Catch()
export class moonExceptionFilter implements ExceptionFilter {
    ...
    if (exception instanceof HttpException) {
      ...
      if (body && typeof body === 'object') {
        ...
        // moon-native shape ({ error } / { error, code } from guards + the Zod
