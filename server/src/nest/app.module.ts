...
import { MoonsExceptionFilter } from './common/moons-exception.filter';
...
@Module({
  ...
  providers: [
    ...
    { provide: APP_FILTER, useClass: MoonsExceptionFilter },
    ...
    // is more specific than moonExceptionFilter, so Nest routes 404s here.
