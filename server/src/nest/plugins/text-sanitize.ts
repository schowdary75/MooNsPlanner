/**
 * moon renders its UI with a single icon language (lucide) and no emojis. Plugin
 * authors — especially AI-generated ones — tend to sprinkle emojis into the declarative
 * text moon renders NATIVELY (badges, columns, warnings, PDF sections, map-marker labels,
 ...
 * text moon draws in its own chrome stays emoji-free. A plugin that wants an icon uses
