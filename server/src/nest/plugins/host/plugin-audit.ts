 ...
 * moon grant broad reads to large addons without raising risk.
 */
...
// Per-plugin retention cap for the audit table — it lives in the SHARED moon.db, and a
...
const MAX_AUDIT_ROWS = envInt('moon_PLUGIN_AUDIT_MAX_ROWS', 20_000);
