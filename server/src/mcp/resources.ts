...
export function registerResources(server: McpServer, userId: number, scopes: string[] | null): void {
  ...
  if (canReadTrips(scopes)) server.registerResource(
    'trip',
    new ResourceTemplate('moon://trips/{tripId}', { list: undefined }),
  ...
  if (canReadTrips(scopes)) server.registerResource(
    'trip-days',
    new ResourceTemplate('moon://trips/{tripId}/days', { list: undefined }),
  ...
  if (canRead(scopes, 'places')) server.registerResource(
    'trip-places',
    new ResourceTemplate('moon://trips/{tripId}/places', { list: undefined }),
  ...
  if (isAddonEnabled(ADDON_IDS.BUDGET) && canRead(scopes, 'budget')) server.registerResource(
    'trip-budget',
    new ResourceTemplate('moon://trips/{tripId}/budget', { list: undefined }),
  ...
  if (isAddonEnabled(ADDON_IDS.PACKING) && canRead(scopes, 'packing')) server.registerResource(
    'trip-packing',
    new ResourceTemplate('moon://trips/{tripId}/packing', { list: undefined }),
  ...
  if (canRead(scopes, 'reservations')) server.registerResource(
    'trip-reservations',
    new ResourceTemplate('moon://trips/{tripId}/reservations', { list: undefined }),
  ...
  if (canReadTrips(scopes)) server.registerResource(
    'day-notes',
    new ResourceTemplate('moon://trips/{tripId}/days/{dayId}/notes', { list: undefined }),
  ...
  if (canReadTrips(scopes)) server.registerResource(
    'trip-accommodations',
    new ResourceTemplate('moon://trips/{tripId}/accommodations', { list: undefined }),
  ...
  if (canReadTrips(scopes)) server.registerResource(
    'trip-members',
    new ResourceTemplate('moon://trips/{tripId}/members', { list: undefined }),
  ...
  if (collabFeatures?.notes && canRead(scopes, 'collab')) server.registerResource(
    'trip-collab-notes',
    new ResourceTemplate('moon://trips/{tripId}/collab-notes', { list: undefined }),
  ...
  if (isAddonEnabled(ADDON_IDS.PACKING) && canRead(scopes, 'todos')) server.registerResource(
    'trip-todos',
    new ResourceTemplate('moon://trips/{tripId}/todos', { list: undefined }),
  ...
  if (isAddonEnabled(ADDON_IDS.BUDGET) && canRead(scopes, 'budget')) server.registerResource(
    ...
    new ResourceTemplate('moon://trips/{tripId}/budget/per-person', { list: undefined }),
  ...
  if (isAddonEnabled(ADDON_IDS.BUDGET) && canRead(scopes, 'budget')) server.registerResource(
    ...
    new ResourceTemplate('moon://trips/{tripId}/budget/settlement', { list: undefined }),
  ...
  if (isAddonEnabled(ADDON_IDS.PACKING) && canRead(scopes, 'packing')) server.registerResource(
    'trip-packing-bags',
    new ResourceTemplate('moon://trips/{tripId}/packing/bags', { list: undefined }),
  ...
  if (collabFeatures?.polls && canRead(scopes, 'collab')) {
    server.registerResource(
      'trip-collab-polls',
      new ResourceTemplate('moon://trips/{tripId}/collab/polls', { list: undefined }),
  ...
  if (collabFeatures?.chat && canRead(scopes, 'collab')) {
    server.registerResource(
      ...
      new ResourceTemplate('moon://trips/{tripId}/collab/messages', { list: undefined }),
  ...
  if (isAddonEnabled(ADDON_IDS.VACAY) && canRead(scopes, 'vacay')) {
    ...
    server.registerResource(
      'vacay-entries',
      new ResourceTemplate('moon://vacay/entries/{year}', { list: undefined }),
    ...
    server.registerResource(
      'vacay-holidays',
      new ResourceTemplate('moon://vacay/holidays/{year}', { list: undefined }),
  ...
  if (isAddonEnabled(ADDON_IDS.JOURNEY) && canRead(scopes, 'journey')) {
    ...
    server.registerResource(
      'journey-detail',
      new ResourceTemplate('moon://journeys/{journeyId}', { list: undefined }),
    ...
    server.registerResource(
      'journey-entries',
      new ResourceTemplate('moon://journeys/{journeyId}/entries', { list: undefined }),
    ...
    server.registerResource(
      ...
      new ResourceTemplate('moon://journeys/{journeyId}/contributors', { list: undefined }),
