...
export const moonClientsStore: OAuthRegisteredClientsStore = {
...
export const moonOAuthProvider: OAuthServerProvider = {
    get clientsStore() { return moonClientsStore; },
    ...
    async authorize(client: OAuthClientInformationFull, params: AuthorizationParams, res: Response): Promise<void> {
        ...
        if (resource !== mcpResource) {
            ...
            url.searchParams.set('error_description', 'Requested resource must be the moon MCP endpoint');
