...
/**
 * Builds the unified moon NestJS application that serves the ENTIRE surface — the
 ...
 *   4b. setupApiDocs — Swagger UI/spec at /api/docs* when moon_API_DOCS_ENABLED;
 ...
 * moonExceptionFilter (also APP_FILTER).
 */
