...
This is a minimal Helm chart for deploying the MooNs app.

## Features
- Deploys the MooNs container
...
```sh
helm repo add moons https://schowdary75.github.io/MooNsPlanner
helm repo update
helm install moons moons/moons
```

> **Note:** `https://schowdary75.github.io/MooNsPlanner` is the hosted Helm chart repository.
