# Contributing to MooNs

Thanks for your interest in contributing! Please read these guidelines before opening a pull request.

## Ground Rules

1. **Open an Issue first** — Before writing any code, pitch your idea in a GitHub Issue or Discussion. We'll let you know if the PR is wanted and give direction. PRs that show up without prior discussion may be closed
...
7. **Branch up to date** — Your branch must be [up to date with `dev`](https://github.com/schowdary75/MooNsPlanner/wiki/Development-environment#3-keep-your-fork-up-to-date) before submitting a PR
...
- Wasn't discussed and approved in an issue or PR first
...
See the [Developer Environment page](https://github.com/schowdary75/MooNsPlanner/wiki/Development-environment) for more information on setting up your development environment.

## More Details

See the [Contributing wiki page](https://github.com/schowdary75/MooNsPlanner/wiki/Contributing) for the full tech stack, architecture overview, and detailed guidelines.
