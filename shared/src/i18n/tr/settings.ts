...
const settings: TranslationStrings = {
  ...
  'settings.ntfyUrl.topicPlaceholder': 'benim-moon-uyarilari',
  ...
  'settings.about.supporters.title': 'moon için seyahat Arkadaşları',
  'settings.about.supporters.subtitle':
    "While you're planning your next route, these folks are helping plan moon's future. Their monthly contribution goes straight into development and real hours spent — so moon stays Open Source.",
  ...
  'settings.about.description':
    'moon, seyahatlerinizi ilk fikirden son anıya kadar organize etmenize yardımcı olan, kendi kendine barındırılan bir seyahat planlayıcıdır. Gün planlaması, bütçe, paketleme listeleri, fotoğraflar ve çok daha fazlası; hepsi tek bir yerde, kendi sunucunuzda.',
  'settings.about.madeWith': 'İle yapıldı',
  'settings.about.madeBy': 'MooN ve büyüyen bir açık kaynak topluluğu tarafından.',
  ...
  'settings.airtrail.writeBackHint':
    'Varsayılan olarak kapalı: AirTrail asıl kaynaktır ve moon yalnızca okur. moon’te yapılan değişiklikleri AirTrail’e geri göndermek için açın.',
