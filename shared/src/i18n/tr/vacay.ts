...
const vacay: TranslationStrings = {
  ...
  'vacay.sharingHint': 'Tatil planınızı diğer moon kullanıcılarıyla paylaşın',
  'vacay.owner': 'Mal sahibi',
  'vacay.shareEmailPlaceholder': 'moon kullanıcısının e-postası',
  ...
  'vacay.inviteHint': 'Başka bir moon kullanıcısını birleşik bir tatil takvimini paylaşmaya davet edin.',
