...
const admin: TranslationStrings = {
  ...
  'admin.plugins.disabledBody':
    'Eklenti çalışma zamanı kapalı (moon_PLUGINS_ENABLED). Bir yönetici sunucu yapılandırmasında etkinleştirene kadar hiçbir eklenti çalışamaz.',
  ...
  'admin.plugins.requiresmoon': 'moon {version}+ gerektirir',
  ...
  'admin.plugins.reviewedMeaning':
    '„İncelendi", bir moon sorumlusunun bu eklentiyi her sürümde kötü amaçlı yazılıma karşı taradığı anlamına gelir — kalite ya da çalışıp çalışmadığı için değil. Bir eklentinin zararsız olduğunun garantisi değildir.',
  ...
  'admin.plugins.sig.missingBody':
    'Bu eklenti siz kurduğunuzda imzalıydı, ancak yeni sürüm hiçbir imza içermiyor. moon bu geriye gidişi sessizce kabul etmez. Bu durum geçersiz kılınamaz.',
  ...
  'admin.plugins.sig.confirmOutOfBand':
    'moon, meşru bir anahtar değişimini bir ele geçirmeden ayırt edemez — buradan bakıldığında ikisi birebir aynı görünür. Kabul etmeden önce yeni anahtarı, zaten güvendiğiniz bir kanaldan yazara doğrulatın. Doğruladığınızda eklenti güncellenir ve yeni anahtar hatırlanır.',
  ...
  'admin.plugins.security.trustBody':
    'Bir eklenti yüklemek, herhangi bir üçüncü taraf uygulamasını yüklemek gibidir: yalnızca güvendiğiniz geliştiricilerin kodunu ekleyin ve şüpheye düştüğünüzde önce kendiniz inceleyin. moon, üçüncü taraf eklentiler için hiçbir sorumluluk kabul etmez.',
  ...
  'admin.plugins.dep.moonIncompatible': 'moon {range} gerektiriyor — bu sunucu {host} çalıştırıyor',
  'admin.plugins.dep.moonUnknown': 'Hangi moon sürümlerini desteklediğini belirtmiyor',
  ...
  'admin.addons.subtitle': 'moon deneyiminizi özelleştirmek için özellikleri etkinleştirin veya devre dışı bırakın.',
  ...
  'admin.weather.description':
    "moon, hava durumu veri kaynağı olarak Open-Meteo'yu kullanıyor. Open-Meteo ücretsiz, açık kaynaklı bir hava durumu hizmetidir; API anahtarı gerekmez.",
  ...
  'admin.github.by': 'ile',
  'admin.github.support': "moon'i geliştirmeye devam etmeme yardımcı oluyor",
  'admin.update.available': 'Güncelleme mevcut',
  'admin.update.text': 'moon {version} mevcut. {current} çalıştırıyorsunuz.',
  ...
  'admin.update.confirmText':
    'moon, {current} sürümünden {version} sürümüne güncellenecek. Sunucu daha sonra otomatik olarak yeniden başlatılacaktır.',
  ...
  'admin.update.dockerText':
    "moon örneğiniz Docker'da çalışır. {version} sürümüne güncellemek için sunucunuzda aşağıdaki komutları çalıştırın:",
  'admin.update.nonDockerText':
    'Bu moon örneği Docker üzerinde çalışmıyor. {version} sürümüne güncellemek için kullandığınız kurulum veya güncelleme yöntemini yeniden çalıştırın — örneğin Proxmox Community Scripts kullanıyorsanız güncellemeyi LXC konsolundan çalıştırın:',
  ...
  'admin.passkey.rpIdHint':
    'Passkey’lerin bağlı olduğu yalın alan adı, ör. moon.example.org. APP_URL’den türetmek için boş bırakın. Daha sonra değiştirmek mevcut passkey’leri geçersiz kılar.',
  'admin.passkey.origins': 'İzin verilen kaynaklar',
  'admin.passkey.originsHint':
    'Virgülle ayrılmış tam kaynaklar, ör. https://moon.example.org. APP_URL kullanmak için boş bırakın.',
