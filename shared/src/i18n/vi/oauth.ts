...
const oauth: TranslationStrings = {
  ...
  'oauth.authorize.loginDescription': '{client} muốn truy cập vào tài khoản moon của bạn. Vui lòng đăng nhập trước.',
  'oauth.authorize.loginButton': 'Đăng nhập vào moon',
  'oauth.authorize.requestLabel': 'Yêu cầu ủy quyền',
  'oauth.authorize.requestDescription': 'Ứng dụng này đang yêu cầu quyền truy cập vào tài khoản moon của bạn.',
