...
const admin: TranslationStrings = {
  ...
  'admin.notifications.adminNtfyPanel.topicPlaceholder': 'moon-admin-cảnh báo',
  ...
  'admin.plugins.disabledBody':
    'Môi trường chạy plugin đang bị tắt (moon_PLUGINS_ENABLED). Không plugin nào có thể chạy cho đến khi quản trị viên bật nó trong cấu hình máy chủ.',
  ...
  'admin.plugins.requiresmoon': 'Yêu cầu moon {version}+',
  ...
  'admin.plugins.reviewedMeaning':
    '"Đã kiểm duyệt" nghĩa là một người bảo trì moon đã quét plugin này để tìm mã độc trên mỗi phiên bản — không phải về chất lượng hay việc nó có hoạt động hay không. Đây không phải là bảo đảm rằng plugin vô hại.',
  ...
  'admin.plugins.sig.missingBody':
    'Plugin này đã được ký khi bạn cài đặt, nhưng phiên bản mới không kèm chữ ký nào. moon sẽ không lặng lẽ chấp nhận bước lùi đó. Không thể bỏ qua điều này.',
  ...
  'admin.plugins.sig.confirmOutOfBand':
    'moon không thể phân biệt một lần xoay khóa hợp lệ với một vụ chiếm quyền — nhìn từ đây, cả hai giống hệt nhau. Hãy xác nhận khóa mới với tác giả qua một kênh mà bạn đã tin tưởng trước khi chấp nhận nó. Khi bạn chấp nhận, plugin sẽ được cập nhật và khóa mới sẽ được ghi nhớ.',
  ...
  'admin.plugins.security.trustBody':
    'Cài đặt một plugin cũng giống như cài đặt bất kỳ ứng dụng bên thứ ba nào: chỉ cài đặt mã từ những tác giả bạn tin tưởng, và khi còn nghi ngờ, hãy tự kiểm tra nó trước. moon không chịu trách nhiệm về các plugin của bên thứ ba.',
  ...
  'admin.plugins.dep.moonIncompatible': 'Cần moon {range} — máy chủ này đang chạy {host}',
  'admin.plugins.dep.moonUnknown': 'Không nêu rõ hỗ trợ những phiên bản moon nào',
  ...
  'admin.addons.subtitle': 'Bật hoặc tắt các tính năng để tùy chỉnh trải nghiệm moon của bạn.',
  ...
  'admin.weather.description':
    'moon sử dụng Open-Meteo làm nguồn dữ liệu thời tiết. Open-Meteo là dịch vụ thời tiết nguồn mở, miễn phí — không yêu cầu khóa API.',
  ...
  'admin.github.by': 'qua',
  'admin.github.support': 'Giúp tôi tiếp tục xây dựng moon',
  'admin.update.available': 'Đã có bản cập nhật',
  'admin.update.text': 'moon {version} có sẵn. Bạn đang chạy {current}.',
  ...
  'admin.update.confirmText':
    'moon sẽ được cập nhật từ {current} lên {version}. Máy chủ sẽ tự động khởi động lại sau đó.',
  ...
  'admin.update.dockerText':
    'Phiên bản moon của bạn chạy trong Docker. Để cập nhật lên {version}, hãy chạy các lệnh sau trên máy chủ của bạn:',
  'admin.update.nonDockerText':
    'Phiên bản moon này không chạy trong Docker. Để cập nhật lên {version}, hãy chạy lại phương pháp cài đặt hoặc cập nhật mà bạn đã sử dụng — ví dụ: trên Proxmox Community Script chạy bản cập nhật từ bảng điều khiển LXC:',
