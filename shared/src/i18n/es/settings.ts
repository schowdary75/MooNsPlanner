...
const settings: TranslationStrings = {
  ...
  'settings.about.supporters.title': 'Compañía de viaje para moon',
  'settings.about.supporters.subtitle':
    'Mientras planeas tu próxima ruta, estas personas ayudan a planear el futuro de moon. Su aporte mensual va directo al desarrollo y a las horas reales invertidas — para que moon siga siendo Open Source.',
  ...
  'settings.about.description':
    'moon es un planificador de viajes autoalojado que te ayuda a organizar tus viajes desde la primera idea hasta el último recuerdo. Planificación diaria, presupuesto, listas de equipaje, fotos y mucho más — todo en un solo lugar, en tu propio servidor.',
  'settings.about.madeWith': 'Hecho con',
  'settings.about.madeBy': 'por MooN y una creciente comunidad de código abierto.',
  ...
  'settings.airtrail.writeBackHint':
    'Desactivado por defecto: AirTrail es la fuente de referencia y moon solo lee de él. Actívalo para enviar a AirTrail los cambios hechos en moon.',
