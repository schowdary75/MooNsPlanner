...
const admin: TranslationStrings = {
  ...
  'admin.plugins.disabledBody':
    'El entorno de ejecución de plugins está apagado (moon_PLUGINS_ENABLED). Ningún plugin puede ejecutarse hasta que un administrador lo active en la configuración del servidor.',
  ...
  'admin.plugins.requiresmoon': 'Requiere moon {version}+',
  ...
  'admin.plugins.reviewedMeaning':
    '"Revisado" significa que un responsable de moon analizó este plugin en busca de malware en cada versión, no su calidad ni si funciona. No es una garantía de que un plugin sea inofensivo.',
  ...
  'admin.plugins.sig.missingBody':
    'Este plugin estaba firmado cuando lo instalaste, pero la nueva versión no incluye ninguna firma. moon no aceptará esa degradación en silencio. Esto no se puede omitir.',
  ...
  'admin.plugins.sig.confirmOutOfBand':
    'moon no puede distinguir una rotación de clave legítima de un secuestro — desde aquí ambas se ven idénticas. Confirma la nueva clave con el autor por un canal en el que ya confíes antes de aceptarla. Cuando lo hagas, el plugin se actualizará y la nueva clave quedará registrada.',
  ...
  'admin.plugins.security.trustBody':
    'Instalar un plugin es como instalar cualquier aplicación de terceros: añade únicamente código de autores en los que confíes y, en caso de duda, inspecciónalo tú mismo primero. moon no asume ninguna responsabilidad por los plugins de terceros.',
  ...
  'admin.plugins.dep.moonIncompatible': 'Necesita moon {range} — este servidor ejecuta {host}',
  'admin.plugins.dep.moonUnknown': 'No indica qué versiones de moon admite',
  ...
  'admin.addons.subtitle': 'Activa o desactiva funciones para personalizar tu experiencia en moon.',
  ...
  'admin.weather.description':
    'moon utiliza Open-Meteo como fuente de datos meteorológicos. Open-Meteo es un servicio meteorológico gratuito y de código abierto: no requiere clave API.',
  ...
  'admin.github.support': 'Ayuda a seguir desarrollando moon',
  'admin.github.error': 'No se pudieron cargar las versiones',
  'admin.github.by': 'por',
  'admin.update.available': 'Actualización disponible',
  'admin.update.text': 'moon {version} está disponible. Estás usando {current}.',
  ...
  'admin.update.confirmText':
    'moon se actualizará de {current} a {version}. Después, el servidor se reiniciará automáticamente.',
  ...
  'admin.update.dockerText':
    'Tu instancia de moon se ejecuta en Docker. Para actualizar a {version}, ejecuta los siguientes comandos en tu servidor:',
  'admin.update.nonDockerText':
    'Esta instancia de moon no se ejecuta en Docker. Para actualizar a {version}, vuelve a ejecutar el método de instalación o actualización que utilizaste; por ejemplo, en Proxmox Community Scripts ejecuta la actualización desde la consola LXC:',
  ...
  'admin.passkey.rpIdHint':
    'El dominio puro al que se vinculan las passkeys, p. ej. moon.example.org. Déjalo vacío para derivarlo de APP_URL. Cambiarlo más adelante invalida las passkeys existentes.',
  'admin.passkey.origins': 'Orígenes permitidos',
  'admin.passkey.originsHint':
    'Orígenes completos separados por comas, p. ej. https://moon.example.org. Déjalo vacío para usar APP_URL.',
