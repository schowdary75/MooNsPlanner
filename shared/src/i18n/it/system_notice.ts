...
const system_notice: TranslationStrings = {
  'system_notice.welcome_v1.title': 'Benvenuto su moon',
  ...
  'system_notice.welcome_v1.hero_alt': "Destinazione di viaggio panoramica con l'interfaccia moon",
  ...
  'system_notice.thank_you_support.title': 'Grazie per usare moon',
  'system_notice.thank_you_support.body':
    "Un piccolo grazie per aver installato moon — significa davvero molto per me.\n\nSono uno sviluppatore indipendente e creo moon nel mio tempo libero. È nato come un piccolo strumento solo per i miei viaggi, e sono sinceramente sbalordito dal supporto e dall'interesse che la community mi ha dimostrato da allora. moon è fatto con tanto cuore da parte mia — ma anche grazie ai tanti fantastici collaboratori esterni che hanno contribuito a dargli forma.\n\n**moon è open source e completamente gratuito — e resterà così per sempre. Nessun piano a pagamento, nessun abbonamento, nessuna fregatura. Te lo prometto.**\n\nSe moon ti è utile e vuoi sostenerne lo sviluppo, un piccolo caffè mi aiuta davvero a continuare a costruirlo — nessuna pressione, ma ogni tazza tiene vive le notti tarde.\n\nGrazie per essere qui.\n\n— MooN",
  ...
  'system_notice.thank_you_support.cta_github': 'Supporta su github.com',
  ...
  'system_notice.v3_mcp.body':
    "L'integrazione MCP è stata completamente rinnovata. OAuth 2.1 è ora il metodo di autenticazione consigliato. I token statici (moon_…) sono deprecati e verranno rimossi in una versione futura.",
  ...
  'system_notice.v3_mcp.highlight_deprecated': 'Token statici moon_ deprecati',
  ...
  'system_notice.v3_thankyou.body':
    "Prima di andare avanti — voglio prendermi un momento.\n\nmoon è nato come un progetto secondario che ho costruito per i miei viaggi. Non avrei mai immaginato che sarebbe cresciuto fino a diventare qualcosa di cui 4.000 di voi si fidano per pianificare le proprie avventure. Ogni stella, ogni issue, ogni richiesta di funzionalità — le leggo tutte, e sono loro a tenermi in piedi nelle notti tarde tra un lavoro a tempo pieno e l'università.\n\nVoglio che sappiate: moon sarà sempre open source, sempre self-hosted, sempre vostro. Nessun tracciamento, nessun abbonamento, nessuna fregatura. Solo uno strumento creato da qualcuno che ama viaggiare tanto quanto voi.\n\nUn ringraziamento speciale a [MooN](https://github.com/MooN) — sei diventato un collaboratore incredibile. Molto di ciò che rende la 3.0 fantastica porta la tua impronta. Grazie per aver creduto in questo progetto quando era ancora acerbo.\n\nE a ognuno di voi che ha segnalato un bug, tradotto una stringa, condiviso moon con un amico o semplicemente lo ha usato per pianificare un viaggio — **grazie**. Voi siete il motivo per cui tutto questo esiste.\n\nA molte altre avventure insieme.\n\n— MooN\n\n---\n\n[Unisciti alla community su Discord](https://discord.gg/7Q6M6jDwzf)\n\nSe moon rende i tuoi viaggi migliori, un [piccolo caffè](https://github.com/schowdary75) aiuta sempre a tenere le luci accese.",
