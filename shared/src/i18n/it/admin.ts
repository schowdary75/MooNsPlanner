...
const admin: TranslationStrings = {
  ...
  'admin.plugins.disabledBody':
    'Il runtime dei plugin è disattivato (moon_PLUGINS_ENABLED). Nessun plugin può essere eseguito finché un amministratore non lo abilita nella configurazione del server.',
  ...
  'admin.plugins.requiresmoon': 'Richiede moon {version}+',
  ...
  'admin.plugins.reviewedMeaning':
    '"Verificato" significa che un manutentore di moon ha esaminato questo plugin alla ricerca di malware a ogni versione — non ne ha valutato la qualità né il funzionamento. Non è una garanzia che il plugin sia innocuo.',
  ...
  'admin.plugins.security.reviewedBody':
    'Un plugin verificato è stato esaminato manualmente alla ricerca di malware da un manutentore di moon a ogni versione — controllato per individuare codice ostile, non per valutare se funziona bene. Non è una promessa che il plugin sia innocuo.',
  'admin.plugins.security.signedTitle': 'Cosa significa "Firmato"',
  'admin.plugins.security.signedBody':
    "Il checksum che moon verifica a ogni installazione dimostra che i file sono esattamente quelli garantiti dal registro. Una firma dimostra un'altra cosa: che provengono dall'autore, firmati con una chiave che solo lui possiede. Un plugin firmato ha entrambe le cose. Uno non firmato non è insicuro — porta semplicemente una garanzia in meno, e oggi la maggior parte dei plugin nel registro non è firmata.",
  ...
  'admin.plugins.sig.missingBody':
    "Questo plugin era firmato quando l'hai installato, ma la nuova versione non include alcuna firma. moon non accetterà in silenzio questo passo indietro. Non è possibile forzare questo blocco.",
  ...
  'admin.plugins.sig.confirmOutOfBand':
    "moon non può distinguere una legittima rotazione della chiave da un'appropriazione — da qui appaiono identiche. Prima di accettarla, conferma la nuova chiave con l'autore attraverso un canale di cui ti fidi già. Una volta fatto, il plugin viene aggiornato e la nuova chiave viene memorizzata.",
  ...
  'admin.plugins.security.trustBody':
    'Installare un plugin è come installare una qualsiasi app di terze parti: aggiungi solo codice di autori di cui ti fidi e, in caso di dubbio, ispezionalo personalmente prima. moon non si assume alcuna responsabilità per i plugin di terze parti.',
  ...
  'admin.plugins.dep.moonIncompatible': 'Richiede moon {range} — questo server esegue {host}',
  'admin.plugins.dep.moonUnknown': 'Non indica quali versioni di moon supporta',
  ...
  'admin.addons.subtitle': 'Abilita o disabilita le funzionalità per personalizzare la tua esperienza moon.',
  ...
  'admin.weather.description':
    'moon utilizza Open-Meteo come fonte dei dati meteo. Open-Meteo è un servizio meteo gratuito e open-source — non è richiesta alcuna chiave API.',
  ...
  'admin.github.by': 'da',
  'admin.github.support': 'Mi aiuta a continuare a sviluppare moon',
  'admin.update.available': 'Aggiornamento disponibile',
  'admin.update.text': 'moon {version} è disponibile. Stai eseguendo {current}.',
  ...
  'admin.update.confirmText':
    'moon verrà aggiornato da {current} a {version}. Il server si riavvierà automaticamente in seguito.',
  ...
  'admin.update.dockerText':
    'La tua istanza moon è in esecuzione in Docker. Per aggiornare alla versione {version}, esegui i seguenti comandi sul tuo server:',
  'admin.update.nonDockerText':
    "Questa istanza moon non è in esecuzione in Docker. Per aggiornare alla versione {version}, riesegui il metodo di installazione o aggiornamento che hai usato — ad esempio, su Proxmox Community Scripts esegui l'aggiornamento dalla console LXC:",
  ...
  'admin.notifications.adminNtfyPanel.topicPlaceholder': 'moon-admin-alerts',
  ...
  'admin.passkey.rpIdHint':
    'Il dominio puro a cui le passkey sono associate, es. moon.example.org. Lascia vuoto per derivarlo da APP_URL. Modificarlo in seguito invalida le passkey esistenti.',
  'admin.passkey.origins': 'Origini consentite',
  'admin.passkey.originsHint':
    'Origini complete separate da virgola, es. https://moon.example.org. Lascia vuoto per usare APP_URL.',
