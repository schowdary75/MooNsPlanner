...
const system_notice: TranslationStrings = {
  'system_notice.welcome_v1.title': 'Selamat datang di moon',
  ...
  'system_notice.welcome_v1.hero_alt': 'Destinasi wisata indah dengan antarmuka moon',
  ...
  'system_notice.thank_you_support.title': 'Terima kasih telah memakai moon',
  'system_notice.thank_you_support.body':
    'Sekadar ucapan terima kasih singkat karena telah memasang moon — ini benar-benar berarti banyak bagi saya.\n\nSaya seorang developer solo dan membangun moon di waktu luang. Awalnya hanya alat kecil untuk perjalanan saya sendiri, dan sejujurnya saya terharu dengan dukungan serta minat dari komunitas sejak saat itu. moon dibuat dengan sepenuh hati dari saya — tetapi juga berkat banyak kontributor eksternal hebat yang telah membantu membentuknya.\n\n**moon bersifat open source dan sepenuhnya gratis — dan akan selalu begitu, selamanya. Tanpa paket berbayar, tanpa langganan, tanpa syarat tersembunyi. Saya janji.**\n\nJika moon bermanfaat bagimu dan kamu ingin mendukung pengembangannya, secangkir kopi kecil sungguh membantu saya untuk terus membangun — sama sekali tanpa paksaan, tapi setiap cangkir membuat malam-malam panjang ini tetap berjalan.\n\nTerima kasih telah berada di sini.\n\n— MooN',
  ...
  'system_notice.thank_you_support.cta_github': 'Dukung di github.com',
  ...
  'system_notice.v3_mcp.body':
    'Integrasi MCP telah sepenuhnya diperbarui. OAuth 2.1 kini menjadi metode autentikasi yang direkomendasikan. Token statis (moon_…) sudah usang dan akan dihapus pada versi mendatang.',
  ...
  'system_notice.v3_mcp.highlight_deprecated': 'Token statis moon_ sudah usang',
  ...
  'system_notice.v3_thankyou.body':
    'Sebelum kamu lanjut — saya ingin berhenti sejenak.\n\nmoon dimulai sebagai proyek sampingan yang saya buat untuk perjalanan saya sendiri. Saya tidak pernah membayangkan ia akan tumbuh menjadi sesuatu yang dipercaya oleh 4.000 dari kalian untuk merencanakan petualangan. Setiap bintang, setiap issue, setiap permintaan fitur — saya membaca semuanya, dan itulah yang membuat saya terus bertahan di malam-malam larut antara pekerjaan penuh waktu dan kuliah.\n\nSaya ingin kalian tahu: moon akan selalu open source, selalu self-hosted, selalu milik kalian. Tanpa pelacakan, tanpa langganan, tanpa syarat tersembunyi. Hanya sebuah alat yang dibuat oleh seseorang yang mencintai traveling sama seperti kalian.\n\nTerima kasih khusus untuk [MooN](https://github.com/MooN) — kamu telah menjadi kolaborator yang luar biasa. Begitu banyak hal yang membuat versi 3.0 hebat memiliki jejakmu. Terima kasih telah percaya pada proyek ini ketika masih kasar.\n\nDan untuk setiap dari kalian yang melaporkan bug, menerjemahkan string, membagikan moon kepada teman, atau sekadar menggunakannya untuk merencanakan perjalanan — **terima kasih**. Kalianlah alasan semua ini ada.\n\nUntuk lebih banyak petualangan bersama.\n\n— MooN\n\n---\n\n[Bergabunglah dengan komunitas di Discord](https://discord.gg/7Q6M6jDwzf)\n\nJika moon membuat perjalananmu lebih baik, [secangkir kopi kecil](https://github.com/schowdary75) selalu membantu menjaga lampu tetap menyala.',
