...
const admin: TranslationStrings = {
  ...
  'admin.plugins.disabledBody':
    'Runtime plugin sedang dimatikan (moon_PLUGINS_ENABLED). Tidak ada plugin yang bisa berjalan sampai admin mengaktifkannya di konfigurasi server.',
  ...
  'admin.plugins.requiresmoon': 'Memerlukan moon {version}+',
  ...
  'admin.plugins.reviewedMeaning':
    '"Ditinjau" berarti seorang maintainer moon memindai plugin ini dari malware pada setiap versi — bukan untuk kualitas atau apakah plugin ini berfungsi. Ini bukan jaminan bahwa sebuah plugin tidak berbahaya.',
  ...
  'admin.plugins.sig.missingBody':
    'Plugin ini ditandatangani saat kamu memasangnya, tetapi versi barunya tidak menyertakan tanda tangan. moon tidak akan diam-diam menerima kemunduran itu. Ini tidak bisa dilewati.',
  ...
  'admin.plugins.sig.confirmOutOfBand':
    'moon tidak bisa membedakan pergantian kunci yang sah dari pengambilalihan — dari sini keduanya terlihat sama persis. Pastikan dulu kunci baru itu ke pembuatnya lewat saluran yang sudah kamu percaya sebelum kamu menerimanya. Setelah kamu menerimanya, plugin diperbarui dan kunci barunya diingat.',
  ...
  'admin.plugins.security.trustBody':
    'Memasang plugin sama seperti memasang aplikasi pihak ketiga mana pun: hanya tambahkan kode dari pembuat yang kamu percaya, dan jika ragu, periksa sendiri terlebih dahulu. moon tidak bertanggung jawab atas plugin pihak ketiga.',
  ...
  'admin.plugins.dep.moonIncompatible': 'Membutuhkan moon {range} — server ini menjalankan {host}',
  'admin.plugins.dep.moonUnknown': 'Tidak menyatakan versi moon mana yang didukung',
  ...
  'admin.addons.subtitle': 'Aktifkan atau nonaktifkan fitur untuk menyesuaikan pengalaman moon kamu.',
  ...
  'admin.weather.description':
    'moon menggunakan Open-Meteo sebagai sumber data cuaca. Open-Meteo adalah layanan cuaca gratis dan open-source — tidak perlu kunci API.',
  ...
  'admin.github.support': 'Bantu saya terus mengembangkan moon',
  'admin.update.available': 'Pembaruan tersedia',
  'admin.update.text': 'moon {version} tersedia. Kamu menggunakan {current}.',
  'admin.update.button': 'Lihat di GitHub',
  'admin.update.install': 'Pasang Pembaruan',
  'admin.update.confirmTitle': 'Pasang Pembaruan?',
  'admin.update.confirmText':
    'moon akan diperbarui dari {current} ke {version}. Server akan restart otomatis setelahnya.',
  ...
  'admin.update.dockerText':
    'Instans moon kamu berjalan di Docker. Untuk memperbarui ke {version}, jalankan perintah berikut di servermu:',
  'admin.update.nonDockerText':
    'Instans moon ini tidak berjalan di Docker. Untuk memperbarui ke {version}, jalankan ulang metode instalasi atau pembaruan yang kamu gunakan — misalnya, pada Proxmox Community Scripts jalankan pembaruan dari konsol LXC:',
  ...
  'admin.passkey.rpIdHint':
    'Domain murni tempat passkey diikat, mis. moon.example.org. Kosongkan untuk mengambilnya dari APP_URL. Mengubahnya nanti akan membatalkan passkey yang sudah ada.',
  'admin.passkey.origins': 'Origin yang diizinkan',
  'admin.passkey.originsHint':
    'Origin lengkap dipisahkan koma, mis. https://moon.example.org. Kosongkan untuk menggunakan APP_URL.',
