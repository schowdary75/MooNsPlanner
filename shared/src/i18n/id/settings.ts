...
const settings: TranslationStrings = {
  ...
  'settings.about.supporters.title': 'Rekan perjalanan untuk moon',
  'settings.about.supporters.subtitle':
    'Saat kamu merencanakan rute berikutnya, orang-orang ini ikut merencanakan masa depan moon. Kontribusi bulanan mereka langsung masuk ke pengembangan dan jam kerja nyata — supaya moon tetap Open Source.',
  ...
  'settings.about.description':
    'moon adalah perencana perjalanan self-hosted yang membantu kamu mengatur perjalanan dari ide pertama hingga kenangan terakhir. Perencanaan harian, anggaran, daftar bawaan, foto dan masih banyak lagi — semua di satu tempat, di servermu sendiri.',
  'settings.about.madeWith': 'Dibuat dengan',
  'settings.about.madeBy': 'oleh MooN dan komunitas open-source yang terus berkembang.',
  ...
  'settings.airtrail.writeBackHint':
    'Nonaktif secara bawaan: AirTrail adalah sumber kebenaran dan moon hanya membaca darinya. Aktifkan untuk mengirim perubahan yang dibuat di moon kembali ke AirTrail.',
  ...
  'settings.offline.mode.forceHint':
    'Bekerja hanya dari data cache dan anmoonan perubahanmu. Matikan untuk terhubung kembali dan menyinkronkan.',
  'settings.offline.mode.active':
    'Mode offline aktif — perubahanmu dianmoonan dan akan disinkronkan saat kamu mematikannya.',
  ...
  'settings.offline.banner.queued': 'Offline · {count} dianmoonan',
