...
const admin: TranslationStrings = {
  ...
  'admin.plugins.disabledBody':
    'De plugin-runtime staat uit (moon_PLUGINS_ENABLED). Er kan geen plugin draaien totdat een beheerder dit inschakelt in de serverconfiguratie.',
  ...
  'admin.plugins.requiresmoon': 'Vereist moon {version}+',
  ...
  'admin.plugins.reviewedMeaning':
    '"Beoordeeld" betekent dat een moon-beheerder deze plugin bij elke versie op malware heeft gecontroleerd — niet op kwaliteit of op de vraag of hij werkt. Het is geen garantie dat een plugin ongevaarlijk is.',
  ...
  'admin.plugins.sig.missingBody':
    'Deze plugin was ondertekend toen je hem installeerde, maar de nieuwe versie levert geen handtekening mee. moon aanvaardt die stap terug niet stilzwijgend. Dit kan niet worden genegeerd.',
  ...
  'admin.plugins.sig.confirmOutOfBand':
    'moon kan een legitieme sleutelwissel niet onderscheiden van een overname — van hieruit zien ze er identiek uit. Bevestig de nieuwe sleutel bij de auteur via een kanaal dat je al vertrouwt voordat je hem accepteert. Zodra je dat doet, wordt de plugin bijgewerkt en wordt de nieuwe sleutel onthouden.',
  ...
  'admin.plugins.security.trustBody':
    'Een plugin installeren is als het installeren van elke andere app van derden: voeg alleen code toe van auteurs die je vertrouwt en controleer deze bij twijfel eerst zelf. moon aanvaardt geen enkele verantwoordelijkheid voor plugins van derden.',
  ...
  'admin.plugins.dep.moonIncompatible': 'Vereist moon {range} — deze server draait {host}',
  'admin.plugins.dep.moonUnknown': 'Geeft niet aan welke moon-versies worden ondersteund',
  ...
  'admin.addons.subtitle': 'Schakel functies in of uit om je moon-ervaring aan te passen.',
  ...
  'admin.weather.description':
    'moon gebruikt Open-Meteo als weerbron. Open-Meteo is een gratis, open-source weerdienst — geen API-sleutel vereist.',
  ...
  'admin.oauthSessions.revokeTitle': 'Sessie inmoonken',
  ...
  'admin.github.support': 'Helpt mij moon verder te ontwikkelen',
  'admin.github.error': 'Releases laden mislukt',
  'admin.github.by': 'door',
  'admin.update.available': 'Update beschikbaar',
  'admin.update.text': 'moon {version} is beschikbaar. Je draait {current}.',
  'admin.update.button': 'Bekijk op GitHub',
  'admin.update.install': 'Update installeren',
  'admin.update.confirmTitle': 'Update installeren?',
  'admin.update.confirmText': 'moon wordt bijgewerkt van {current} naar {version}. De server herstart automatisch.',
  ...
  'admin.update.dockerText':
    "Je moon-instantie draait in Docker. Om bij te werken naar {version}, voer de volgende commando's uit op je server:",
  'admin.update.nonDockerText':
    'Deze moon-instantie draait niet in Docker. Om bij te werken naar {version}, voer de installatie- of updatemethode die je hebt gebruikt opnieuw uit — bij Proxmox Community Scripts voer je de update bijvoorbeeld uit vanuit de LXC-console:',
  ...
  'admin.passkey.rpIdHint':
    'Het kale domein waaraan passkeys zijn gebonden, bijv. moon.example.org. Laat leeg om het af te leiden uit APP_URL. Als je dit later wijzigt, worden bestaande passkeys ongeldig.',
  'admin.passkey.origins': 'Toegestane origins',
  'admin.passkey.originsHint':
    "Volledige origins, gescheiden door komma's, bijv. https://moon.example.org. Laat leeg om APP_URL te gebruiken.",
