...
const settings: TranslationStrings = {
  ...
  'settings.oauth.revoke': 'Inmoonken',
  'settings.oauth.revokeSession': 'Sessie inmoonken',
  'settings.oauth.revokeSessionMessage': 'Dit moont onmiddellijk de toegang voor deze OAuth-sessie in.',
  ...
  'settings.oauth.modal.machineClientHint':
    "Gebruikt de client_credentials grant — geen redirect-URI's nodig. Het token wordt direct versmoont via client_id + client_secret en handelt namens jou binnen de geselecteerde scopes.",
  ...
  'settings.about.supporters.title': 'Reisgezelschap voor moon',
  'settings.about.supporters.subtitle':
    'Terwijl jij je volgende route plant, plannen deze mensen mee aan de toekomst van moon. Hun maandelijkse bijdrage gaat rechtstreeks naar ontwikkeling en echte uren — zodat moon Open Source blijft.',
  ...
  'settings.about.description':
    "moon is een zelf-gehoste reisplanner die je helpt je reizen te organiseren van het eerste idee tot de laatste herinnering. Dagplanning, budget, paklijsten, foto's en nog veel meer — alles op één plek, op je eigen server.",
  'settings.about.madeWith': 'Gemaakt met',
  'settings.about.madeBy': 'door MooN en een groeiende open-source community.',
  ...
  'settings.ntfyUrl.topicPlaceholder': 'my-moon-alerts',
  ...
  'settings.airtrail.writeBackHint':
    'Standaard uit: AirTrail is de bron van waarheid en moon leest er alleen uit. Schakel in om in moon gemaakte wijzigingen terug te sturen naar AirTrail.',
