...
const system_notice: TranslationStrings = {
  'system_notice.welcome_v1.title': 'Welkom bij moon',
  ...
  'system_notice.welcome_v1.hero_alt': 'Schilderachtige reisbestemming met moon interface',
  ...
  'system_notice.thank_you_support.title': 'Bedankt voor het gebruik van moon',
  'system_notice.thank_you_support.body':
    'Even een kort bedankje dat je moon hebt geïnstalleerd — het betekent echt veel voor me.\n\nIk ben een solo-ontwikkelaar en bouw moon in mijn vrije tijd. Het begon als een klein hulpmiddel voor mijn eigen reizen, en ik ben oprecht overweldigd door de steun en de interesse vanuit de community sindsdien. moon is met heel veel hart gemaakt aan mijn kant — maar ook dankzij de vele geweldige externe bijdragers die hebben geholpen het vorm te geven.\n\n**moon is open source en volledig gratis — en dat zal het voor altijd blijven. Geen betaalde versies, geen abonnementen, geen addertjes onder het gras. Dat beloof ik.**\n\nAls moon nuttig voor je is en je de ontwikkeling ervan wilt steunen, helpt een klein kopje koffie me oprecht om te blijven bouwen — absoluut geen druk, maar elk kopje houdt de late avonden gaande.\n\nBedankt dat je er bent.\n\n— MooN',
  ...
  'system_notice.thank_you_support.cta_github': 'Steun op github.com',
  ...
  'system_notice.v3_mcp.body':
    'De MCP-integratie is volledig vernieuwd. OAuth 2.1 is nu de aanbevolen authenticatiemethode. Statische tokens (moon_…) zijn verouderd en worden verwijderd in een toekomstige versie.',
  ...
  'system_notice.v3_mcp.highlight_deprecated': 'Statische moon_-tokens verouderd',
  ...
  'system_notice.v3_thankyou.body':
    'Voordat je verdergaat — ik wil even stilstaan.\n\nmoon begon als een zijproject dat ik bouwde voor mijn eigen reizen. Ik had nooit gedacht dat het zou uitgroeien tot iets waar 4.000 van jullie op vertrouwen om avonturen te plannen. Elke ster, elke issue, elk functieverzoek — ik lees ze allemaal, en ze houden me op de been tijdens de late avonden tussen een fulltime baan en de universiteit.\n\nIk wil dat jullie weten: moon zal altijd open source zijn, altijd self-hosted, altijd van jullie. Geen tracking, geen abonnementen, geen addertjes. Gewoon een tool gebouwd door iemand die net zo veel van reizen houdt als jullie.\n\nSpeciale dank aan [MooN](https://github.com/MooN) — je bent een ongelooflijke medewerker geworden. Zo veel van wat 3.0 geweldig maakt draagt jouw vingerafdruk. Bedankt dat je in dit project geloofde toen het nog ruw was.\n\nEn aan ieder van jullie die een bug meldde, een string vertaalde, moon deelde met een vriend of het simpelweg gebruikte om een reis te plannen — **bedankt**. Jullie zijn de reden dat dit bestaat.\n\nOp nog vele avonturen samen.\n\n— MooN\n\n---\n\n[Sluit je aan bij de community op Discord](https://discord.gg/7Q6M6jDwzf)\n\nAls moon je reizen beter maakt, houdt een [klein kopje koffie](https://github.com/schowdary75) altijd de lichten aan.',
