...
const trip: TranslationStrings = {
  ...
  'trip.invite.linkHint':
    'Iedereen met een moon-account die deze link opent, neemt als lid deel aan de reis. Genereer opnieuw om de oude link ongeldig te maken.',
