...
const admin: TranslationStrings = {
  ...
  'admin.plugins.disabledBody':
    'Die Plugin-Laufzeit ist ausgeschaltet (moon_PLUGINS_ENABLED). Es kann kein Plugin laufen, bis ein Admin sie in der Serverkonfiguration aktiviert.',
  ...
  'admin.plugins.requiresmoon': 'Benötigt moon {version}+',
  ...
  'admin.plugins.reviewedMeaning':
    '„Geprüft" heißt: Ein moon-Maintainer hat den Code dieses Plugins bei jeder Version manuell auf Schadsoftware gescannt — nicht auf Qualität oder Funktion. Es ist keine Garantie, dass ein Plugin harmlos ist.',
  ...
  'admin.plugins.security.reviewedBody':
    'Ein geprüftes Plugin wurde bei jeder Version von einem moon-Maintainer manuell auf Schadsoftware gescannt — geprüft auf feindlichen Code, nicht darauf, ob es gut funktioniert. Es ist kein Versprechen, dass das Plugin harmlos ist.',
  'admin.plugins.security.signedTitle': 'Was „Signiert" bedeutet',
  'admin.plugins.security.signedBody':
    'Die Prüfsumme, die moon bei jeder Installation prüft, belegt, dass die Dateien genau das sind, wofür die Registry einsteht. Eine Signatur belegt etwas anderes: dass sie vom Autor stammen, signiert mit einem Schlüssel, den nur er besitzt. Ein signiertes Plugin hat beides. Ein unsigniertes ist nicht unsicher — es trägt schlicht eine Garantie weniger, und die meisten Plugins in der Registry sind heute unsigniert.',
  ...
  'admin.plugins.sig.missingBody':
    'Dieses Plugin war signiert, als du es installiert hast, aber die neue Version bringt keine Signatur mit. moon akzeptiert diesen Rückschritt nicht stillschweigend. Das lässt sich nicht übergehen.',
  ...
  'admin.plugins.sig.confirmOutOfBand':
    'moon kann einen legitimen Schlüsselwechsel nicht von einer Übernahme unterscheiden — von hier aus sehen beide gleich aus. Bestätige den neuen Schlüssel beim Autor über einen Kanal, dem du bereits vertraust, bevor du ihn annimmst. Sobald du das tust, wird das Plugin aktualisiert und der neue Schlüssel gemerkt.',
  ...
  'admin.plugins.security.trustBody':
    'Ein Plugin zu installieren ist wie jede fremde App zu installieren: Füge nur Code von Autoren hinzu, denen du vertraust, und prüfe ihn im Zweifel zuerst selbst. moon übernimmt keine Verantwortung für Plugins von Drittanbietern.',
  ...
  'admin.plugins.dep.moonIncompatible': 'Benötigt moon {range} — auf diesem Server läuft {host}',
  'admin.plugins.dep.moonUnknown': 'Gibt nicht an, welche moon-Versionen unterstützt werden',
  ...
  'admin.addons.subtitle': 'Aktiviere oder deaktiviere Funktionen, um moon nach deinen Wünschen anzupassen.',
  ...
  'admin.weather.description':
    'moon nutzt Open-Meteo als Wetterdatenquelle. Open-Meteo ist ein kostenloser, quelloffener Wetterdienst — es wird kein API-Schlüssel benötigt.',
  ...
  'admin.github.by': 'von',
  'admin.github.support': 'Hilft mir, moon weiterzuentwickeln',
  'admin.update.available': 'Update verfügbar',
  'admin.update.text': 'moon {version} ist verfügbar. Du verwendest {current}.',
  ...
  'admin.update.confirmText':
    'moon wird von {current} auf {version} aktualisiert. Der Server startet danach automatisch neu.',
  ...
  'admin.update.dockerText':
    'Deine moon-Instanz läuft in Docker. Um auf {version} zu aktualisieren, führe folgende Befehle auf deinem Server aus:',
  'admin.update.nonDockerText':
    'Diese moon-Instanz läuft nicht in Docker. Um auf {version} zu aktualisieren, führe die Installations- oder Update-Methode erneut aus, die du verwendet hast — bei Proxmox Community Scripts startest du das Update zum Beispiel über die LXC-Konsole:',
  ...
  'admin.passkey.rpIdHint':
    'Die reine Domain, an die Passkeys gebunden sind, z. B. moon.example.org. Leer lassen, um sie aus APP_URL abzuleiten. Eine spätere Änderung macht bestehende Passkeys ungültig.',
  'admin.passkey.origins': 'Erlaubte Origins',
  'admin.passkey.originsHint':
    'Vollständige Origins, durch Komma getrennt, z. B. https://moon.example.org. Leer lassen, um APP_URL zu verwenden.',
