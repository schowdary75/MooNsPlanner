...
const system_notice: TranslationStrings = {
  'system_notice.welcome_v1.title': 'Willkommen bei moon',
  ...
  'system_notice.welcome_v1.hero_alt': 'Malerisches Reiseziel mit moon-Planungs-UI',
  ...
  'system_notice.thank_you_support.title': 'Danke, dass du moon nutzt',
  'system_notice.thank_you_support.body':
    'Ein kurzes Dankeschön, dass du moon installiert hast — das bedeutet mir wirklich viel.\n\nIch bin Solo-Entwickler und baue moon in meiner Freizeit. Angefangen hat alles als kleines Tool nur für meine eigenen Reisen, und ich bin ehrlich überwältigt von der Unterstützung und dem Interesse der Community seitdem. In moon steckt viel Herzblut von meiner Seite — aber auch viele großartige externe Mitwirkende haben es mitgeprägt.\n\n**moon ist Open Source und vollständig kostenlos — und das bleibt für immer so. Keine Paid Tiers, keine Abos, kein Haken. Versprochen.**\n\nWenn moon dir nützt und du die Entwicklung unterstützen möchtest, hilft mir ein kleiner Kaffee wirklich beim Weitermachen — überhaupt kein Druck, aber jede Tasse trägt durch die langen Nächte.\n\nDanke, dass du dabei bist.\n\n— MooN',
  ...
  'system_notice.thank_you_support.cta_github': 'github.com unterstützen',
  ...
  'system_notice.v3_mcp.body':
    'Die MCP-Integration wurde vollständig überarbeitet. OAuth 2.1 ist jetzt die empfohlene Authentifizierungsmethode. Statische Tokens (moon_…) sind veraltet und werden in einer zukünftigen Version entfernt.',
  ...
  'system_notice.v3_mcp.highlight_deprecated': 'Statische moon_-Tokens veraltet',
  ...
  'system_notice.v3_thankyou.body':
    'Bevor du weiterklickst — einen Moment noch.\n\nmoon hat als Nebenprojekt für meine eigenen Reisen angefangen. Ich hätte nie gedacht, dass es jemals so weit kommt, dass 4.000 von euch damit ihre Abenteuer planen. Jeder Stern, jedes Issue, jeder Feature-Wunsch — ich lese sie alle, und sie halten mich am Laufen durch die späten Nächte zwischen Vollzeitjob und Studium.\n\nEins will ich euch sagen: moon wird immer Open Source bleiben, immer self-hosted, immer eures. Kein Tracking, keine Abos, keine versteckten Haken. Einfach ein Tool, gebaut von jemandem, der das Reisen genauso liebt wie ihr.\n\nBesonderer Dank an [MooN](https://github.com/MooN) — du bist ein unglaublicher Mitstreiter geworden. So vieles, was 3.0 großartig macht, trägt deine Handschrift. Danke, dass du an dieses Projekt geglaubt hast, als es noch holprig war.\n\nUnd an jeden einzelnen von euch, der einen Bug gemeldet, einen String übersetzt, moon mit Freunden geteilt oder einfach damit eine Reise geplant hat — **danke**. Ihr seid der Grund, warum es das hier gibt.\n\nAuf viele weitere Abenteuer zusammen.\n\n— MooN\n\n---\n\n[Tritt der Community auf Discord bei](https://discord.gg/7Q6M6jDwzf)\n\nWenn moon deine Reisen besser macht, hält ein [kleiner Kaffee](https://github.com/schowdary75) die Lichter an.',
