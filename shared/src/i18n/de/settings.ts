...
const settings: TranslationStrings = {
  ...
  'settings.about.supporters.title': 'Reisebegleitung für moon',
  'settings.about.supporters.subtitle':
    'Während du deine nächste Route planst, planen diese Leute mit, wie moon weitergeht. Ihr monatlicher Beitrag fließt direkt in Entwicklung und echten Zeitaufwand — damit moon Open Source bleibt.',
  ...
  'settings.about.description':
    'moon ist ein selbst gehosteter Reiseplaner, der dir hilft, deine Trips von der ersten Idee bis zur letzten Erinnerung zu organisieren. Tagesplanung, Budget, Packlisten, Fotos und vieles mehr — alles an einem Ort, auf deinem eigenen Server.',
  'settings.about.madeWith': 'Entwickelt mit',
  'settings.about.madeBy': 'von MooN und einer wachsenden Open-Source-Community.',
  ...
  'settings.airtrail.writeBackHint':
    'Standardmäßig aus: AirTrail ist die maßgebliche Quelle und moon liest nur. Aktivieren, um in moon vorgenommene Änderungen zurück an AirTrail zu senden.',
