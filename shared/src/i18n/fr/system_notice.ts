...
const system_notice: TranslationStrings = {
  'system_notice.welcome_v1.title': 'Bienvenue sur moon',
  ...
  'system_notice.welcome_v1.hero_alt': "Destination de voyage pittoresque avec l'interface moon",
  ...
  'system_notice.thank_you_support.title': "Merci d'utiliser moon",
  'system_notice.thank_you_support.body':
    "Un petit mot pour te remercier d'avoir installé moon — ça compte vraiment beaucoup pour moi.\n\nJe suis développeur en solo et je construis moon sur mon temps libre. Au départ, c'était juste un petit outil pour mes propres voyages, et je suis honnêtement bluffé par le soutien et l'intérêt de la communauté depuis. moon est fait avec beaucoup de cœur de mon côté — mais aussi grâce aux nombreux et formidables contributeurs externes qui ont aidé à lui donner forme.\n\n**moon est open source et entièrement gratuit — et le restera pour toujours. Pas de formules payantes, pas d'abonnements, aucun piège. Promis.**\n\nSi moon t'est utile et que tu souhaites soutenir son développement, un petit café m'aide sincèrement à continuer — sans aucune pression, mais chaque tasse fait avancer les nuits blanches.\n\nMerci d'être là.\n\n— MooN",
  ...
  'system_notice.thank_you_support.cta_github': 'Soutenir sur github.com',
  ...
  'system_notice.v3_mcp.body':
    "L'intégration MCP a été entièrement repensée. OAuth 2.1 est désormais la méthode d'authentification recommandée. Les tokens statiques (moon_…) sont dépréciés et seront supprimés dans une future version.",
  ...
  'system_notice.v3_mcp.highlight_deprecated': 'Tokens statiques moon_ dépréciés',
  ...
  'system_notice.v3_thankyou.body':
    "Avant de continuer — je veux prendre un instant.\n\nmoon a commencé comme un projet perso que j'ai construit pour mes propres voyages. Je n'aurais jamais imaginé qu'il grandirait au point que 4 000 d'entre vous lui fassent confiance pour planifier vos aventures. Chaque étoile, chaque issue, chaque demande de fonctionnalité — je les lis toutes, et ce sont elles qui me font tenir pendant les nuits blanches entre un travail à temps plein et l'université.\n\nJe veux que vous sachiez : moon sera toujours open source, toujours auto-hébergé, toujours à vous. Pas de tracking, pas d'abonnements, pas de conditions cachées. Juste un outil construit par quelqu'un qui aime voyager autant que vous.\n\nUn merci tout particulier à [MooN](https://github.com/MooN) — tu es devenu un collaborateur incroyable. Une grande partie de ce qui rend la 3.0 géniale porte ton empreinte. Merci d'avoir cru en ce projet quand il était encore brut.\n\nEt à chacun d'entre vous qui a signalé un bug, traduit une chaîne, partagé moon avec un ami ou simplement l'a utilisé pour planifier un voyage — **merci**. Vous êtes la raison pour laquelle tout ceci existe.\n\nÀ de nombreuses autres aventures ensemble.\n\n— MooN\n\n---\n\n[Rejoins la communauté sur Discord](https://discord.gg/7Q6M6jDwzf)\n\nSi moon rend tes voyages meilleurs, un [petit café](https://github.com/schowdary75) aide toujours à garder les lumières allumées.",
