...
const admin: TranslationStrings = {
  ...
  'admin.plugins.disabledBody':
    "L'environnement d'exécution des plugins est désactivé (moon_PLUGINS_ENABLED). Aucun plugin ne peut fonctionner tant qu'un administrateur ne l'active pas dans la configuration du serveur.",
  ...
  'admin.plugins.requiresmoon': 'Nécessite moon {version}+',
  ...
  'admin.plugins.reviewedMeaning':
    "« Vérifié » signifie qu'un mainteneur de moon a analysé ce plugin à la recherche de logiciels malveillants à chaque version — non pour sa qualité ni son bon fonctionnement. Ce n'est pas une garantie qu'un plugin est inoffensif.",
  ...
  'admin.plugins.sig.missingBody':
    "Ce plugin était signé lorsque vous l'avez installé, mais la nouvelle version ne fournit aucune signature. moon n'acceptera pas ce recul en silence. Impossible de passer outre.",
  ...
  'admin.plugins.security.trustBody':
    "Installer un plugin revient à installer n'importe quelle application tierce : n'ajoutez que du code provenant d'auteurs de confiance et, en cas de doute, inspectez-le vous-même au préalable. moon décline toute responsabilité concernant les plugins tiers.",
  ...
  'admin.plugins.dep.moonIncompatible': 'Nécessite moon {range} — ce serveur exécute {host}',
  'admin.plugins.dep.moonUnknown': 'N’indique pas quelles versions de moon sont prises en charge',
  ...
  'admin.addons.subtitle': 'Activez ou désactivez des fonctionnalités pour personnaliser votre expérience moon.',
  ...
  'admin.weather.description':
    'moon utilise Open-Meteo comme source de données météo. Open-Meteo est un service météo gratuit et open source — aucune clé API requise.',
  ...
  'admin.github.support': 'Aidez à poursuivre le développement de moon',
  'admin.github.error': 'Impossible de charger les versions',
  'admin.github.by': 'par',
  'admin.update.available': 'Mise à jour disponible',
  'admin.update.text': 'moon {version} est disponible. Vous utilisez {current}.',
  ...
  'admin.update.confirmText':
    'moon sera mis à jour de {current} vers {version}. Le serveur redémarrera automatiquement ensuite.',
  ...
  'admin.update.dockerText':
    'Votre instance moon fonctionne dans Docker. Pour mettre à jour vers {version}, exécutez les commandes suivantes sur votre serveur :',
  'admin.update.nonDockerText':
    "Cette instance moon ne fonctionne pas dans Docker. Pour mettre à jour vers {version}, relancez la méthode d'installation ou de mise à jour que vous avez utilisée — par exemple, sur Proxmox Community Scripts, lancez la mise à jour depuis la console LXC :",
  ...
  'admin.passkey.rpIdHint':
    "Le domaine nu auquel les passkeys sont liées, ex. moon.example.org. Laissez vide pour le déduire d'APP_URL. Le modifier ultérieurement invalide les passkeys existantes.",
  'admin.passkey.origins': 'Origines autorisées',
  'admin.passkey.originsHint':
    'Origines complètes séparées par des virgules, ex. https://moon.example.org. Laissez vide pour utiliser APP_URL.',
