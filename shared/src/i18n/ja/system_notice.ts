...
const system_notice: TranslationStrings = {
  ...
  'system_notice.v3_photos.body':
    '旅行プランナー内の写真は削除されましたが、写真データは安全です。moonがImmichやSynologyのライブラリを変更することはありません。\n\n写真は現在日記アドオンにあります。日記は任意機能です。未有効の場合は、管理画面 → アドオンで有効にしてください。',
  ...
  'system_notice.v3_mcp.body':
    'MCP連携が全面的に刷新されました。OAuth 2.1が推奨認証方式です。従来の静的トークン（moon_…）は非推奨となり、将来削除されます。',
  'system_notice.v3_mcp.highlight_oauth': 'OAuth 2.1推奨（mcp-remote）',
  'system_notice.v3_mcp.highlight_scopes': '24の詳細な権限スコープ',
  'system_notice.v3_mcp.highlight_deprecated': '静的moon_トークンは非推奨',
  'system_notice.v3_mcp.highlight_tools': 'ツールとプロンプトを拡張',
  'system_notice.v3_thankyou.title': '開発者より一言',
  'system_notice.v3_thankyou.body':
    '少しだけお時間をください。\n\nmoonは、自分の旅のために作った小さな個人プロジェクトでした。それが今では4,000人以上に使ってもらえるとは思ってもいませんでした。スターも、Issueも、機能要望も、すべて目を通しています。\n\nmoonはこれからもオープンソース、自分でホストでき、あなたのものです。トラッキングなし、サブスクなし。旅が好きな人が作ったツールです。\n\nhttps://github.com/MooNにも感謝を。3.0の多くはあなたのおかげです。\n\nバグ報告、翻訳、共有、利用してくれたすべての方へ—本当にありがとうございます。\n\nこれからも一緒に旅を。\n\n— MooN',
  ...
  'system_notice.thank_you_support.title': 'moonを使ってくれてありがとう',
  'system_notice.thank_you_support.body':
    'moonをインストールしてくれて、ちょっとお礼を言わせてください。本当に、心から嬉しいです。\n\n私は一人で開発をしていて、moonは空いた時間に作っています。もともとは自分の旅のためだけの小さなツールでしたが、それ以来コミュニティから寄せられる応援や関心に、正直なところ圧倒されています。moonは私自身がたくさんの思いを込めて作っていますが、それと同時に、形づくるのを手伝ってくれた多くの素晴らしい外部コントリビューターのおかげでもあります。\n\n**moonはオープンソースで、完全に無料です。そしてこれからもずっと変わりません。有料プランも、サブスクリプションも、隠れた仕掛けも、一切ありません。約束します。**\n\nもしmoonがあなたの役に立っていて、開発を応援したいと思ってもらえたなら、ちょっとしたコーヒー一杯が、これからも作り続ける本当の支えになります。まったく無理はしないでください。でも一杯ごとに、夜なべの作業が続けられます。\n\nここにいてくれて、ありがとう。\n\n— MooN',
  ...
  'system_notice.thank_you_support.cta_github': 'github.comで応援する',
