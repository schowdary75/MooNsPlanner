...
const settings: TranslationStrings = {
  ...
  'settings.about.supporters.title': 'moonの旅仲間',
  'settings.about.supporters.subtitle': '皆さんの支援がmoonの未来を支えています。',
  ...
  'settings.about.description': 'moonはセルフホスト型の旅行プランナーです。',
  'settings.about.madeWith': 'Made with',
  'settings.about.madeBy': 'by MooN とオープンソースコミュニティ。',
  ...
  'settings.airtrail.writeBackHint':
    '既定ではオフ: AirTrail が信頼できる情報源で、moon は読み取りのみを行います。moon で行った編集を AirTrail に書き戻すにはオンにします。',
