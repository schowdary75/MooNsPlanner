...
const settings: TranslationStrings = {
  ...
  'settings.about.supporters.title': 'Towarzystwo podróży dla moon',
  'settings.about.supporters.subtitle':
    'Gdy planujesz kolejną trasę, te osoby planują razem ze mną przyszłość moon. Ich comiesięczny wkład idzie bezpośrednio na rozwój i realnie przepracowane godziny — aby moon pozostał Open Source.',
  ...
  'settings.about.description':
    'moon to samodzielnie hostowany planer podróży, który pomaga organizować wyprawy od pierwszego pomysłu po ostatnie wspomnienie. Planowanie dzienne, budżet, listy pakowania, zdjęcia i wiele więcej — wszystko w jednym miejscu, na własnym serwerze.',
  'settings.about.madeWith': 'Stworzone z',
  'settings.about.madeBy': "przez MooN'a i rosnącą społeczność open-source.",
  ...
  'settings.airtrail.writeBackHint':
    'Domyślnie wyłączone: AirTrail jest źródłem prawdy, a moon tylko z niego odczytuje. Włącz, aby wysyłać zmiany wprowadzone w moon z powrotem do AirTrail.',
