...
const admin: TranslationStrings = {
  ...
  'admin.plugins.disabledBody':
    'Środowisko uruchomieniowe wtyczek jest wyłączone (moon_PLUGINS_ENABLED). Żadna wtyczka nie może działać, dopóki administrator nie włączy tej opcji w konfiguracji serwera.',
  ...
  'admin.plugins.requiresmoon': 'Wymaga moon {version}+',
  ...
  'admin.plugins.reviewedMeaning':
    '„Zweryfikowana” oznacza, że opiekun moon przeskanował tę wtyczkę pod kątem złośliwego oprogramowania w każdej wersji — nie pod kątem jakości ani tego, czy działa. To nie jest gwarancja, że wtyczka jest nieszkodliwa.',
  ...
  'admin.plugins.security.reviewedBody':
    'Zweryfikowana wtyczka została ręcznie przeskanowana pod kątem złośliwego oprogramowania przez opiekuna moon w każdej wersji — sprawdzona pod kątem wrogiego kodu, a nie tego, czy działa dobrze. To nie jest obietnica, że wtyczka jest nieszkodliwa.',
  'admin.plugins.security.signedTitle': 'Co oznacza „Podpisana”',
  'admin.plugins.security.signedBody':
    'Suma kontrolna, którą moon weryfikuje przy każdej instalacji, dowodzi, że pliki są dokładnie tym, za co ręczy rejestr. Podpis dowodzi czegoś innego: że pochodzą od autora i zostały podpisane kluczem, który ma tylko on. Podpisana wtyczka ma jedno i drugie. Wtyczka bez podpisu nie jest niebezpieczna — po prostu niesie o jedną gwarancję mniej, a większość wtyczek w rejestrze jest dziś niepodpisana.',
  ...
  'admin.plugins.sig.missingBody':
    'Ta wtyczka była podpisana, gdy ją instalowałeś, ale nowa wersja nie zawiera żadnego podpisu. moon nie przyjmie po cichu takiego kroku wstecz. Tego nie można pominąć.',
  ...
  'admin.plugins.sig.confirmOutOfBand':
    'moon nie odróżni prawidłowej wymiany klucza od przejęcia wtyczki — stąd wyglądają identycznie. Zanim zaakceptujesz nowy klucz, potwierdź go u autora kanałem, któremu już ufasz. Gdy to zrobisz, wtyczka zostanie zaktualizowana, a nowy klucz zapamiętany.',
  ...
  'admin.plugins.security.trustBody':
    'Instalacja wtyczki jest jak instalacja dowolnej aplikacji innych firm: dodawaj tylko kod od autorów, którym ufasz, a w razie wątpliwości najpierw samodzielnie go sprawdź. moon nie ponosi żadnej odpowiedzialności za wtyczki innych firm.',
  ...
  'admin.plugins.dep.moonIncompatible': 'Wymaga moon {range} — ten serwer działa na {host}',
  'admin.plugins.dep.moonUnknown': 'Nie określa, które wersje moon obsługuje',
  ...
  'admin.addons.subtitle': 'Włączaj lub wyłączaj funkcje, aby dostosować swoje doświadczenie w moon.',
  ...
  'admin.weather.description':
    'moon korzysta z Open-Meteo jako źródła danych pogodowych. Open-Meteo to darmowy, otwartoźródłowy serwis pogodowy — klucz API nie jest wymagany.',
  ...
  'admin.github.support': 'Pomóż mi rozwijać moon',
  'admin.update.available': 'Dostępna aktualizacja',
  'admin.update.text': 'Dostępna jest wersja moon {version}. Używasz {current}.',
  ...
  'admin.update.confirmText':
    'moon zostanie zaktualizowany z {current} do {version}. Serwer zostanie automatycznie zrestartowany po zakończeniu.',
  ...
  'admin.update.dockerText':
    'Twoja instancja moon działa w Dockerze. Aby zaktualizować do {version}, uruchom następujące polecenia na swoim serwerze:',
  'admin.update.nonDockerText':
    'Ta instancja moon nie działa w Dockerze. Aby zaktualizować do {version}, uruchom ponownie metodę instalacji lub aktualizacji, której użyłeś — na przykład w Proxmox Community Scripts uruchom aktualizację z konsoli LXC:',
  ...
  'admin.passkey.rpIdHint':
    'Sama domena, do której przypisane są klucze dostępu, np. moon.example.org. Pozostaw puste, aby wyprowadzić ją z APP_URL. Późniejsza zmiana unieważnia istniejące klucze dostępu.',
  'admin.passkey.origins': 'Dozwolone origins',
  'admin.passkey.originsHint':
    'Pełne origins oddzielone przecinkami, np. https://moon.example.org. Pozostaw puste, aby użyć APP_URL.',
