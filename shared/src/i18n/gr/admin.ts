...
const admin: TranslationStrings = {
  ...
  'admin.plugins.disabledBody':
    'Το περιβάλλον εκτέλεσης plugins είναι απενεργοποιημένο (moon_PLUGINS_ENABLED). Κανένα plugin δεν μπορεί να εκτελεστεί μέχρι ένας διαχειριστής να το ενεργοποιήσει στη διαμόρφωση του server.',
  ...
  'admin.plugins.requiresmoon': 'Απαιτεί moon {version}+',
  ...
  'admin.plugins.reviewedMeaning':
    'Το "Ελεγμένο" σημαίνει ότι ένας συντηρητής του moon σάρωσε αυτό το plugin για κακόβουλο λογισμικό σε κάθε έκδοση — όχι για την ποιότητα ή για το αν λειτουργεί. Δεν αποτελεί εγγύηση ότι ένα plugin είναι ακίνδυνο.',
  ...
  'admin.plugins.sig.missingBody':
    'Αυτό το plugin ήταν υπογεγραμμένο όταν το εγκαταστήσατε, αλλά η νέα έκδοση δεν περιλαμβάνει καμία υπογραφή. Το moon δεν θα δεχτεί σιωπηλά αυτή την υποβάθμιση. Αυτό δεν μπορεί να παρακαμφθεί.',
  ...
  'admin.plugins.sig.confirmOutOfBand':
    'Το moon δεν μπορεί να ξεχωρίσει μια νόμιμη αλλαγή κλειδιού από μια κατάληψη — από εδώ φαίνονται πανομοιότυπες. Επιβεβαιώστε το νέο κλειδί με τον δημιουργό μέσω ενός καναλιού που ήδη εμπιστεύεστε, προτού το αποδεχτείτε. Μόλις το κάνετε, το plugin ενημερώνεται και το νέο κλειδί απομνημονεύεται.',
  ...
  'admin.plugins.security.trustBody':
    'Η εγκατάσταση ενός plugin είναι σαν την εγκατάσταση οποιασδήποτε εφαρμογής τρίτου: προσθέστε κώδικα μόνο από δημιουργούς που εμπιστεύεστε, και σε περίπτωση αμφιβολίας, ελέγξτε τον πρώτα μόνοι σας. Το moon δεν αναλαμβάνει καμία ευθύνη για plugins τρίτων.',
  ...
  'admin.plugins.dep.moonIncompatible': 'Απαιτεί moon {range} — αυτός ο διακομιστής εκτελεί {host}',
  'admin.plugins.dep.moonUnknown': 'Δεν δηλώνει ποιες εκδόσεις moon υποστηρίζει',
  ...
  'admin.addons.subtitle':
    'Ενεργοποιήστε ή απενεργοποιήστε λειτουργίες για να εξατομικεύσετε την εμπειρία σας στο moon.',
  ...
  'admin.weather.description':
    'Το moon χρησιμοποιεί το Open-Meteo ως πηγή δεδομένων καιρού. Το Open-Meteo είναι μια δωρεάν, ανοιχτού κώδικα υπηρεσία καιρού — δεν απαιτείται κλειδί API.',
  ...
  'admin.github.by': 'από',
  'admin.github.support': 'Βοηθά να συνεχίσω την ανάπτυξη του moon',
  'admin.update.available': 'Διαθέσιμη ενημέρωση',
  'admin.update.text': 'Το moon {version} είναι διαθέσιμο. Εκτελείτε το {current}.',
  ...
  'admin.update.confirmText':
    'Το moon θα ενημερωθεί από {current} σε {version}. Ο server θα επανεκκινήσει αυτόματα στη συνέχεια.',
  ...
  'admin.update.dockerText':
    'Η εγκατάστασή σας moon εκτελείται σε Docker. Για να ενημερωθείτε στο {version}, εκτελέστε τις ακόλουθες εντολές στον server σας:',
  'admin.update.nonDockerText':
    'Αυτή η εγκατάσταση moon δεν εκτελείται σε Docker. Για να ενημερωθείτε στο {version}, εκτελέστε ξανά τη μέθοδο εγκατάστασης ή ενημέρωσης που χρησιμοποιήσατε — για παράδειγμα, στα Proxmox Community Scripts εκτελέστε την ενημέρωση από την κονσόλα LXC:',
  ...
  'admin.passkey.rpIdHint':
    'Ο σκέτος τομέας στον οποίο δεσμεύονται τα passkeys, π.χ. moon.example.org. Αφήστε το κενό για να παραχθεί από το APP_URL. Η μεταγενέστερη αλλαγή του ακυρώνει τα υπάρχοντα passkeys.',
  'admin.passkey.origins': 'Επιτρεπόμενες προελεύσεις',
  'admin.passkey.originsHint':
    'Πλήρεις προελεύσεις χωρισμένες με κόμμα, π.χ. https://moon.example.org. Αφήστε το κενό για χρήση του APP_URL.',
