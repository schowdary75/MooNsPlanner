...
const settings: TranslationStrings = {
  ...
  'settings.about.supporters.title': 'Συνταξιδιώτες για το moon',
  'settings.about.supporters.subtitle':
    'Καθώς εσείς σχεδιάζετε την επόμενή σας διαδρομή, αυτοί οι άνθρωποι βοηθούν να σχεδιαστεί το μέλλον του moon. Η μηνιαία τους συνεισφορά πηγαίνει απευθείας στην ανάπτυξη και σε πραγματικές ώρες εργασίας — ώστε το moon να παραμένει Open Source.',
  ...
  'settings.about.description':
    'Το moon είναι ένας self-hosted ταξιδιωτικός σχεδιαστής που σας βοηθά να οργανώσετε τα ταξίδια σας από την πρώτη ιδέα μέχρι την τελευταία ανάμνηση. Σχεδιασμός ημερών, προϋπολογισμός, λίστες πακεταρίσματος, φωτογραφίες και πολλά άλλα — όλα σε ένα μέρος, στον δικό σας server.',
  'settings.about.madeWith': 'Φτιαγμένο με',
  'settings.about.madeBy': 'από τον MooN και μια αναπτυσσόμενη κοινότητα open-source.',
  ...
  'settings.airtrail.writeBackHint':
    'Απενεργοποιημένο από προεπιλογή: το AirTrail είναι η πηγή αλήθειας και το moon μόνο διαβάζει από αυτό. Ενεργοποιήστε το για να στέλνετε πίσω στο AirTrail τις αλλαγές που κάνετε στο moon.',
