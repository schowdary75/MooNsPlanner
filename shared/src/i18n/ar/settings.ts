...
const settings: TranslationStrings = {
  ...
  'settings.about.supporters.title': 'رفاق رحلة moon',
  'settings.about.supporters.subtitle':
    'بينما تخطّط لمسارك التالي، يساعد هؤلاء الأشخاص في التخطيط لمستقبل moon. تذهب مساهمتهم الشهرية مباشرةً إلى التطوير والساعات الفعلية المبذولة — حتى يظلّ moon مفتوح المصدر.',
  'settings.about.supporters.since': 'داعم منذ {date}',
  'settings.about.supporters.tierEmpty': 'كن الأول',
  'settings.about.description':
    'moon هو مخطط سفر مستضاف ذاتيًا يساعدك على تنظيم رحلاتك من أول فكرة حتى آخر ذكرى. تخطيط يومي، ميزانية، قوائم تعبئة، صور والمزيد — كل شيء في مكان واحد، على خادمك الخاص.',
  ...
  'settings.ntfyUrl.topicPlaceholder': 'my-moon-alerts', // en-fallback
  ...
  'settings.airtrail.writeBackHint':
    'مُعطّل افتراضيًا: AirTrail هو مصدر الحقيقة وmoon يقرأ منه فقط. فعّله لإرسال التعديلات التي تجريها في moon إلى AirTrail.',
