...
const system_notice: TranslationStrings = {
  ...
  'system_notice.v3_mcp.body':
    'تمت إعادة تصميم تكامل MCP بالكامل. OAuth 2.1 هو الآن طريقة المصادقة الموصى بها. الرموز الثابتة (moon_…) مهملة وستُزال في إصدار مستقبلي.',
  ...
  'system_notice.v3_mcp.highlight_deprecated': 'الرموز الثابتة moon_ مهملة',
  'system_notice.v3_mcp.highlight_tools': 'مجموعة أدوات وإرشادات موسعة',
  'system_notice.v3_thankyou.title': 'كلمة شخصية مني',
  'system_notice.v3_thankyou.body':
    'قبل أن تمضي — أريد أن أتوقف لحظة.\n\nبدأ moon كمشروع جانبي بنيته لرحلاتي الخاصة. لم أتخيل يومًا أنه سيكبر ليصبح شيئًا يعتمد عليه 4,000 منكم لتخطيط مغامراتهم. كل نجمة، كل مشكلة، كل طلب ميزة — أقرأها جميعًا، وهي ما يبقيني مستمرًا في الليالي المتأخرة بين عمل بدوام كامل والجامعة.\n\nأريدكم أن تعرفوا: moon سيبقى دائمًا مفتوح المصدر، دائمًا مستضافًا ذاتيًا، دائمًا ملككم. لا تتبع، لا اشتراكات، لا شروط خفية. مجرد أداة بناها شخص يحب السفر بقدر ما تحبونه.\n\nشكر خاص لـ [MooN](https://github.com/MooN) — لقد أصبحت متعاونًا رائعًا. الكثير مما يجعل الإصدار 3.0 عظيمًا يحمل بصماتك. شكرًا لإيمانك بهذا المشروع عندما كان لا يزال في بداياته.\n\nولكل واحد منكم ممن أبلغ عن خطأ، أو ترجم نصًا، أو شارك moon مع صديق، أو ببساطة استخدمه لتخطيط رحلة — **شكرًا لكم**. أنتم السبب في وجود هذا.\n\nإلى المزيد من المغامرات معًا.\n\n— MooN\n\n---\n\n[انضم إلى المجتمع على Discord](https://discord.gg/7Q6M6jDwzf)\n\nإذا جعل moon رحلاتك أفضل، [فنجان قهوة صغير](https://github.com/schowdary75) يبقي الأضواء مشتعلة.',
  ...
  'system_notice.welcome_v1.title': 'مرحبًا بك في moon',
  ...
  'system_notice.welcome_v1.hero_alt': 'وجهة سفر خلابة مع واجهة تطبيق moon',
  ...
  'system_notice.thank_you_support.title': 'شكرًا لاستخدامك moon',
  'system_notice.thank_you_support.body':
    'شكرًا سريعًا على تثبيتك moon — هذا يعني لي الكثير حقًا.\n\nأنا مطوّر منفرد أبني moon في وقت فراغي. بدأ كأداة صغيرة لرحلاتي الخاصة فحسب، وصدقًا أنا مندهش من الدعم والاهتمام اللذين أبداهما المجتمع منذ ذلك الحين. moon مصنوع بكثير من الحب من جانبي — ولكن أيضًا بفضل العديد من المساهمين الخارجيين الرائعين الذين ساعدوا في تشكيله.\n\n**moon مفتوح المصدر ومجاني تمامًا — وسيبقى كذلك إلى الأبد. لا باقات مدفوعة، لا اشتراكات، لا شروط خفية. أعدكم بذلك.**\n\nإذا كان moon مفيدًا لك وأردت دعم تطويره، فإن فنجان قهوة صغيرًا يساعدني حقًا على مواصلة البناء — لا ضغط على الإطلاق، لكن كل فنجان يبقي الليالي المتأخرة مستمرة.\n\nشكرًا لوجودك هنا.\n\n— MooN',
  ...
  'system_notice.thank_you_support.cta_github': 'ادعمني على github.com',
