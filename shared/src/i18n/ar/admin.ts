...
const admin: TranslationStrings = {
  ...
  'admin.plugins.disabledBody':
    'بيئة تشغيل الإضافات متوقفة (moon_PLUGINS_ENABLED). لا يمكن تشغيل أي إضافة حتى يقوم مسؤول بتفعيلها في إعدادات الخادم.',
  ...
  'admin.plugins.requiresmoon': 'يتطلب moon {version}+',
  ...
  'admin.plugins.reviewedMeaning':
    '"تمت مراجعتها" تعني أن أحد القائمين على moon فحص هذه الإضافة بحثًا عن البرمجيات الخبيثة في كل إصدار — وليس من حيث الجودة أو ما إذا كانت تعمل. وهي ليست ضمانًا بأن الإضافة غير ضارة.',
  ...
  'admin.plugins.security.reviewedBody':
    'الإضافة التي تمت مراجعتها فُحصت يدويًا بحثًا عن البرمجيات الخبيثة بواسطة أحد القائمين على moon في كل إصدار — جرى فحصها بحثًا عن شيفرة ضارة، لا لمعرفة ما إذا كانت تعمل جيدًا. وهي ليست وعدًا بأن الإضافة غير ضارة.',
  'admin.plugins.security.signedTitle': 'ماذا تعني "موقّعة"',
  'admin.plugins.security.signedBody':
    'المجموع الاختباري الذي يتحقق منه moon عند كل تثبيت يثبت أن الملفات هي بالضبط ما يضمنه السجل. أما التوقيع فيثبت شيئًا مختلفًا: أنها جاءت من المؤلف، موقّعة بمفتاح لا يملكه سواه. الإضافة الموقّعة تجمع الاثنين معًا. وغير الموقّعة ليست غير آمنة — إنها ببساطة تحمل ضمانًا واحدًا أقل، ومعظم الإضافات في السجل غير موقّعة اليوم.',
  ...
  'admin.plugins.sig.missingBody':
    'كانت هذه الإضافة موقّعة عند تثبيتها، لكن الإصدار الجديد لا يحمل أي توقيع. لن يقبل moon هذا التراجع بصمت. لا يمكن تجاوز ذلك.',
  ...
  'admin.plugins.sig.confirmOutOfBand':
    'لا يستطيع moon التمييز بين تبديل مشروع للمفتاح وبين استيلاء على الإضافة — يبدو الأمران متطابقين من هنا. تحقّق من المفتاح الجديد مع المؤلف عبر قناة تثق بها أصلًا قبل قبوله. وحين تفعل، يتم تحديث الإضافة ويُحفظ المفتاح الجديد.',
  ...
  'admin.plugins.security.trustBody':
    'تثبيت إضافة يشبه تثبيت أي تطبيق من جهة خارجية: لا تُضِف سوى شيفرة من مطورين تثق بهم، وعند الشك، افحصها بنفسك أولًا. لا يتحمل moon أي مسؤولية عن إضافات الجهات الخارجية.',
  ...
  'admin.plugins.dep.moonIncompatible': 'يتطلب moon {range} — يعمل هذا الخادم بالإصدار {host}',
  'admin.plugins.dep.moonUnknown': 'لا يحدد إصدارات moon المدعومة',
  ...
  'admin.addons.subtitle': 'فعّل أو عطّل الميزات لتخصيص تجربة moon.',
  ...
  'admin.weather.description':
    'يستخدم moon خدمة Open-Meteo كمصدر لبيانات الطقس. وهي خدمة مجانية ومفتوحة المصدر ولا تتطلب مفتاح API.',
  ...
  'admin.github.support': 'يساعدني في تطوير moon',
  'admin.update.available': 'يتوفر تحديث',
  'admin.update.text': 'moon {version} متوفر. أنت تستخدم {current}.',
  'admin.update.button': 'عرض على GitHub',
  'admin.update.install': 'تثبيت التحديث',
  'admin.update.confirmTitle': 'تثبيت التحديث؟',
  'admin.update.confirmText': 'سيتم تحديث moon من {current} إلى {version}. سيُعاد تشغيل الخادم تلقائيًا بعد ذلك.',
  ...
  'admin.update.dockerText': 'يعمل moon الخاص بك في Docker. للتحديث إلى {version}، نفّذ الأوامر التالية على الخادم:',
  'admin.update.nonDockerText':
    'لا يعمل moon هذا في Docker. للتحديث إلى {version}، أعد تشغيل طريقة التثبيت أو التحديث التي استخدمتها — على سبيل المثال، في Proxmox Community Scripts نفّذ التحديث من وحدة تحكم LXC:',
  ...
  'admin.notifications.adminNtfyPanel.topicPlaceholder': 'moon-admin-alerts', // en-fallback
  ...
  'admin.passkey.rpIdHint':
    'النطاق المجرّد الذي تُربط به مفاتيح المرور، مثل moon.example.org. اتركه فارغًا لاشتقاقه من APP_URL. تغييره لاحقًا يُبطل مفاتيح المرور الموجودة.',
  'admin.passkey.origins': 'الأصول المسموح بها',
  'admin.passkey.originsHint': 'أصول كاملة مفصولة بفواصل، مثل https://moon.example.org. اتركه فارغًا لاستخدام APP_URL.',
