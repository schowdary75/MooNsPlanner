...
const ar: NotificationLocale = {
  email: {
    footer: 'تلقيت هذا لأنك قمت بتفعيل الإشعارات في moon.',
  ...
  events: {
    ...
    vacay_invite: (p) => ({
      ...
      body: `${p.actor} يدعوك لدمج خطط الإجازة. افتح moon للقبول أو الرفض.`,
    }),
    collection_invite: (p) => ({
      title: 'دعوة إلى مجموعة',
      body: `${p.actor} يدعوك لمشاركة مجموعة. افتح moon للقبول أو الرفض.`,
    }),
    photos_shared: (p) => ({
    ...
    version_available: (p) => ({
      title: 'إصدار moon جديد متاح',
      body: `moon ${p.version} متاح الآن. تفضل بزيارة لوحة الإدارة للتحديث.`,
    }),
  ...
  passwordReset: {
    ...
    greeting: 'مرحبا',
    body: 'تلقينا طلبًا لإعادة تعيين كلمة المرور لحسابك في moon. انقر على الزر أدناه لتعيين كلمة مرور جديدة.',
