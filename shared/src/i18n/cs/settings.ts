...
const settings: TranslationStrings = {
  ...
  'settings.about.supporters.title': 'Společníci na cestě s moon',
  'settings.about.supporters.subtitle':
    'Zatímco plánuješ další trasu, tihle lidé plánují společně se mnou budoucnost moon. Jejich měsíční příspěvek jde přímo na vývoj a reálně strávené hodiny — aby moon zůstal Open Source.',
  ...
  'settings.about.description':
    'moon je samohostovaný plánovač cest, který vám pomůže organizovat výlety od prvního nápadu po poslední vzpomínku. Denní plánování, rozpočet, balicí seznamy, fotky a mnoho dalšího — vše na jednom místě, na vašem vlastním serveru.',
  'settings.about.madeWith': 'Vytvořeno s',
  'settings.about.madeBy': 'MooNm a rostoucí open-source komunitou.',
  ...
  'settings.airtrail.writeBackHint':
    'Ve výchozím stavu vypnuto: AirTrail je zdrojem pravdy a moon z něj pouze čte. Zapněte, chcete-li odesílat úpravy provedené v moon zpět do AirTrail.',
