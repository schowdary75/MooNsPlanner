...
const admin: TranslationStrings = {
  ...
  'admin.plugins.disabledBody':
    'Běhové prostředí pluginů je vypnuté (moon_PLUGINS_ENABLED). Dokud jej administrátor nepovolí v konfiguraci serveru, nemůže běžet žádný plugin.',
  ...
  'admin.plugins.requiresmoon': 'Vyžaduje moon {version}+',
  ...
  'admin.plugins.reviewedMeaning':
    '„Zkontrolováno“ znamená, že správce moon prověřil tento plugin na škodlivý kód u každé verze — nikoli jeho kvalitu ani to, zda funguje. Není to záruka, že je plugin neškodný.',
  ...
  'admin.plugins.security.isolationBody':
    'Plugin běží jako vlastní uzamčený proces, který může číst pouze své vlastní soubory. Nemůže číst vaši databázi, váš přihlašovací tajný klíč ani váš šifrovací klíč, nemůže spouštět jiné programy a nemůže nikam zapisovat soubory. Jeho rozhraní běží v uzavřeném rámci prohlížeče, který nemůže číst vaši session cookie ani zasahovat do okolní stránky moon.',
  'admin.plugins.security.permsTitle': 'Co oprávnění znamenají',
  'admin.plugins.security.permsBody':
    'Oprávnění zobrazená před instalací jsou pevný limit, který moon vynucuje po celou dobu běhu pluginu — plugin doslova nemůže udělat nic, co není na seznamu. Říkají vám ale, co plugin může dělat, nikoli co skutečně dělá. Plugin, který smí číst vaše cesty a spojit se se serverem, může vaše cesty tomuto serveru odeslat, proto si přečtěte oprávnění i odchozí hostitele, nejen popis.',
  'admin.plugins.security.limitsTitle': 'Co nemůžeme slíbit',
  'admin.plugins.security.limitsBody':
    'Izolace je silná softwarová hranice, nikoli absolutní. Plugin jedná přesně s těmi právy, která schválíte, takže v jejich rámci se může chovat jinak, než naznačuje jeho popis, a může odeslat data, která oprávněně drží, hostitelům, které deklaroval. moon nečte ani neposuzuje, co kód pluginu ve skutečnosti dělá.',
  ...
  'admin.plugins.sig.missingBody':
    'Tento plugin byl při instalaci podepsaný, ale nová verze žádný podpis nepřináší. moon takové zhoršení tiše nepřijme. Toto nelze obejít.',
  ...
  'admin.plugins.sig.confirmOutOfBand':
    'moon nedokáže odlišit legitimní výměnu klíče od převzetí pluginu — odsud vypadají obě stejně. Než nový klíč přijmete, ověřte si ho u autora kanálem, kterému už důvěřujete. Jakmile to uděláte, plugin se aktualizuje a nový klíč si moon zapamatuje.',
  ...
  'admin.plugins.security.trustBody':
    'Instalace pluginu je jako instalace jakékoli aplikace třetí strany: přidávejte pouze kód od autorů, kterým důvěřujete, a v případě pochybností si jej nejprve sami prohlédněte. moon nenese žádnou odpovědnost za pluginy třetích stran.',
  ...
  'admin.plugins.dep.moonIncompatible': 'Vyžaduje moon {range} — tento server běží na {host}',
  'admin.plugins.dep.moonUnknown': 'Neuvádí, které verze moon podporuje',
  ...
  'admin.addons.subtitle': 'Zapněte nebo vypněte funkce a přizpůsobte si moon.',
  ...
  'admin.github.by': 'od',
  'admin.github.support': 'Pomáhá udržovat vývoj moon',
  'admin.weather.title': 'Data o počasí',
  'admin.weather.badge': 'Od 24. března 2026',
  'admin.weather.description':
    'moon používá Open-Meteo jako zdroj dat. Je to bezplatná open-source služba – není vyžadován API klíč.',
  ...
  'admin.update.text': 'moon {version} je k dispozici. Aktuálně používáte verzi {current}.',
  ...
  'admin.update.confirmText':
    'moon bude aktualizován z verze {current} na {version}. Server se poté automaticky restartuje.',
  ...
  'admin.update.dockerText':
    'Váš moon běží v Dockeru. Pro aktualizaci na verzi {version} spusťte na svém serveru tyto příkazy:',
  'admin.update.nonDockerText':
    'Tato instance moon neběží v Dockeru. Pro aktualizaci na verzi {version} znovu spusťte instalační nebo aktualizační metodu, kterou jste použili — například u Proxmox Community Scripts spusťte aktualizaci z konzole LXC:',
  ...
  'admin.passkey.rpIdHint':
    'Holá doména, ke které jsou přístupové klíče vázány, např. moon.example.org. Ponechte prázdné, aby se odvodila z APP_URL. Pozdější změna zneplatní stávající přístupové klíče.',
  'admin.passkey.origins': 'Povolené origins',
  'admin.passkey.originsHint':
    'Úplné origins oddělené čárkou, např. https://moon.example.org. Ponechte prázdné pro použití APP_URL.',
