...
const system_notice: TranslationStrings = {
  'system_notice.welcome_v1.title': 'Vítejte v moon',
  ...
  'system_notice.welcome_v1.hero_alt': 'Malebné cestovní místo s rozhraním moon',
  ...
  'system_notice.thank_you_support.title': 'Děkuji, že používáte moon',
  'system_notice.thank_you_support.body':
    'Rychlé poděkování za to, že jste si nainstalovali moon — upřímně, znamená to pro mě hodně.\n\nJsem jediný vývojář a moon tvořím ve svém volném čase. Začalo to jako malý nástroj jen pro mé vlastní cesty a od té doby mě podpora a zájem komunity naprosto dostávají. moon dělám s velkým srdcem — ale také díky mnoha úžasným externím přispěvatelům, kteří ho pomohli utvářet.\n\n**moon je open source a zcela zdarma — a tak to navždy zůstane. Žádné placené verze, žádná předplatná, žádné háčky. Slibuji.**\n\nPokud je pro vás moon užitečný a chtěli byste podpořit jeho vývoj, malá káva mi opravdu pomáhá pokračovat ve tvoření — žádný tlak, ale každý šálek mi pomáhá přečkat pozdní noci.\n\nDěkuji, že jste tady.\n\n— MooN',
  ...
  'system_notice.thank_you_support.cta_github': 'Podpořit na github.com',
  ...
  'system_notice.v3_mcp.body':
    'Integrace MCP byla kompletně přepracována. OAuth 2.1 je nyní doporučenou metodou ověřování. Statické tokeny (moon_…) jsou zastaralé a budou v budoucí verzi odstraněny.',
  ...
  'system_notice.v3_mcp.highlight_deprecated': 'Statické tokeny moon_ zastaralé',
  ...
  'system_notice.v3_thankyou.body':
    'Než budete pokračovat — chci se na chvíli zastavit.\n\nmoon začal jako vedlejší projekt, který jsem vytvořil pro své vlastní cesty. Nikdy jsem si nepředstavoval, že vyroste v něco, čemu 4 000 z vás důvěřuje při plánování svých dobrodružství. Každou hvězdičku, každý issue, každý požadavek na funkci — všechny čtu a právě ony mě drží při životě během pozdních nocí mezi prací na plný úvazek a univerzitou.\n\nChci, abyste věděli: moon bude vždy open source, vždy self-hosted, vždy váš. Žádné sledování, žádná předplatná, žádné háčky. Jen nástroj vytvořený někým, kdo miluje cestování stejně jako vy.\n\nZvláštní poděkování patří [MooN](https://github.com/MooN) — stal ses neuvěřitelným spolupracovníkem. Tolik z toho, co dělá verzi 3.0 skvělou, nese tvůj rukopis. Děkuji, že jsi věřil tomuto projektu, když byl ještě v plenkách.\n\nA každému z vás, kdo nahlásil chybu, přeložil řetězec, sdílel moon s přítelem nebo ho jednoduše použil k plánování cesty — **děkuji**. Vy jste důvod, proč tohle existuje.\n\nNa mnoho dalších dobrodružství společně.\n\n— MooN\n\n---\n\n[Přidej se ke komunitě na Discordu](https://discord.gg/7Q6M6jDwzf)\n\nPokud ti moon zlepšuje cestování, [malá káva](https://github.com/schowdary75) vždy pomůže udržet světla rozsvícená.',
