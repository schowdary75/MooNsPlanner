...
const admin: TranslationStrings = {
  ...
  'admin.addons.subtitle': 'Activa o desactiva funcions per personalitzar la teva experiència a moon.',
  ...
  'admin.weather.description':
    'moon utilitza Open-Meteo com a font de dades meteorològiques. Open-Meteo és un servei meteorològic gratuït i de codi obert: no requereix clau API.',
  ...
  'admin.github.support': 'Ajuda a continuar desenvolupant moon',
  'admin.github.error': "No s'han pogut carregar les versions",
  'admin.github.by': 'per',
  'admin.update.available': 'Actualització disponible',
  'admin.update.text': 'moon {version} està disponible. Estàs utilitzant {current}.',
  ...
  'admin.update.confirmText':
    "moon s'actualitzarà de {current} a {version}. Després, el servidor es reiniciarà automàticament.",
  ...
  'admin.update.dockerText':
    "La teva instància de moon s'executa en Docker. Per actualitzar a {version}, executa les següents ordres al teu servidor:",
  'admin.update.reloadHint': 'Recarrega la pàgina en uns segons.',
  'admin.update.nonDockerText':
    "Aquesta instància de moon no s'executa amb Docker. Per actualitzar a {version}, torna a executar el mètode d'instal·lació o actualització que vas fer servir — per exemple, a Proxmox Community Scripts executa l'actualització des de la consola LXC:",
  ...
  'admin.passkey.rpIdHint':
    "El domini pur al qual estan vinculades les claus d'accés, p. ex. moon.example.org. Deixa-ho buit per derivar-lo d'APP_URL. Canviar-lo més endavant invalida les claus d'accés existents.",
  'admin.passkey.origins': 'Orígens permesos',
  'admin.passkey.originsHint':
    'Orígens complets separats per comes, p. ex. https://moon.example.org. Deixa-ho buit per utilitzar APP_URL.',
  ...
  'admin.plugins.disabledBody':
    "L'entorn d'execució de connectors està desactivat (moon_PLUGINS_ENABLED). Cap connector es pot executar fins que un administrador l'activi a la configuració del servidor.",
  ...
  'admin.plugins.requiresmoon': 'Requereix moon {version}+',
  ...
  'admin.plugins.reviewedMeaning':
    '"Verificat" significa que un mantenidor de moon ha analitzat aquest connector a la recerca de programari maliciós en cada versió, no la seva qualitat ni si funciona. No és cap garantia que un connector sigui inofensiu.',
  ...
  'admin.plugins.security.reviewedBody':
    "Un connector revisat ha estat analitzat manualment a la recerca de programari maliciós per un mantenidor de moon a cada versió — s'hi ha buscat codi hostil, no pas si funciona bé. No és cap garantia que el connector sigui inofensiu.",
  'admin.plugins.security.signedTitle': 'Què vol dir "Signat"',
  'admin.plugins.security.signedBody':
    "La suma de verificació que moon comprova a cada instal·lació demostra que els fitxers són exactament els que el registre avala. Una signatura demostra una altra cosa: que provenen de l'autor, signats amb una clau que només ell posseeix. Un connector signat té totes dues coses. Un connector sense signar no és insegur — simplement té una garantia menys, i actualment la majoria dels connectors del registre no estan signats.",
  ...
  'admin.plugins.sig.missingBody':
    'Aquest connector estava signat quan el vas instal·lar, però la nova versió no inclou cap signatura. moon no acceptarà aquesta degradació en silenci. Això no es pot ometre.',
  ...
  'admin.plugins.sig.confirmOutOfBand':
    "moon no pot distingir una rotació de clau legítima d'una presa de control — des d'aquí totes dues es veuen idèntiques. Confirma la nova clau amb l'autor a través d'un canal en què ja confiïs abans d'acceptar-la. Un cop ho facis, el connector s'actualitza i la nova clau es recorda.",
  ...
  'admin.plugins.security.trustBody':
    "Instal·lar un connector és com instal·lar qualsevol aplicació de tercers: afegeix només codi d'autors en qui confiïs i, en cas de dubte, inspecciona'l tu mateix primer. moon no assumeix cap responsabilitat pels connectors de tercers.",
  ...
  'admin.plugins.dep.moonIncompatible': 'Necessita moon {range} — aquest servidor executa {host}',
  'admin.plugins.dep.moonUnknown': 'No indica quines versions de moon admet',
