...
const system_notice: TranslationStrings = {
  'system_notice.welcome_v1.title': 'Benvingut/da a moon',
  ...
  'system_notice.welcome_v1.hero_alt': 'Destí de viatge pintoresc amb la interfície de moon',
  ...
  'system_notice.v3_photos.body':
    "Les **Fotos** al Planificador de Viatges han estat eliminades. Les teves fotos estan segures — moon mai va modificar la teva biblioteca d'Immich o Synology.\n\nLes fotos ara viuen al complement **Journey**. Journey és opcional — si encara no està disponible, demana al teu admin que l'activi a Admin → Complementos.",
  ...
  'system_notice.v3_mcp.body':
    "La integració MCP ha estat completament renovada. OAuth 2.1 és ara el mètode d'autenticació recomanat. Els tokens estàtics (moon_…) estan obsolets i s'eliminaran en una versió futura.",
  ...
  'system_notice.v3_mcp.highlight_deprecated': 'Tokens estàtics moon_ obsolets',
  ...
  'system_notice.v3_thankyou.body':
    "Abans de continuar — vull prendre'm un moment.\n\nmoon va començar com un projecte personal que vaig construir per als meus propis viatges. Mai vaig imaginar que créixeria fins a convertir-se en una eina en què 4.000 de vosaltres confieu per planificar les vostres aventures. Cada estrella, cada issue, cada sol·licitud de funcionalitat — les llegeixo totes, i són el que em manté dempeus durant les nits llargues entre un treball a jornada completa i la universitat.\n\nVull que sapigueu: moon sempre serà open source, sempre autoallotjat, sempre vostre. Sense rastreig, sense subscripcions, sense lletra petita. Només una eina feta per algú que estima viatjar tant com vosaltres.\n\nUn agraïment especial a [MooN](https://github.com/MooN) — t'has convertit en un col·laborador increïble. Molt del que fa gran la versió 3.0 porta la teva empremta. Gràcies per creure en aquest projecte quan encara era un esborrany.\n\nI a cadascun de vosaltres que va informar d'un error, va traduir un text, va compartir moon amb un amic o simplement el va utilitzar per planificar un viatge — **gràcies**. Vosaltres sou la raó que això existeixi.\n\nPer moltes més aventures junts.\n\n— MooN\n\n---\n\n[Uneix-te a la comunitat a Discord](https://discord.gg/7Q6M6jDwzf)\n\nSi moon millora els teus viatges, un [petit cafè](https://github.com/schowdary75) sempre manté els llums encesos.",
  ...
  'system_notice.thank_you_support.title': 'Gràcies per utilitzar moon',
  'system_notice.thank_you_support.body':
    "Si t'agrada utilitzar moon, considera donar suport al seu desenvolupament de codi obert.",
  ...
  'system_notice.thank_you_support.cta_github': 'Dona suport a github.com',
};
