...
const admin: TranslationStrings = {
  ...
  'admin.plugins.disabledBody':
    'The plugin runtime is turned off (moon_PLUGINS_ENABLED). No plugin can run until an admin enables it in the server configuration.',
  ...
  'admin.plugins.requiresmoon': 'Requires moon {version}+',
  ...
  'admin.plugins.reviewedMeaning':
    '"Reviewed" means a moon maintainer scanned this plugin for malware on each version — not for quality or whether it works. It is not a guarantee that a plugin is harmless.',
  ...
  'admin.plugins.sig.missingBody':
    'This plugin was signed when you installed it, but the new version ships no signature. moon will not quietly accept the downgrade. This cannot be overridden.',
  ...
  'admin.plugins.sig.confirmOutOfBand':
    'moon cannot tell a legitimate key rotation apart from a takeover — both look identical from here. Confirm the new key with the author through a channel you already trust before you accept it. Once you do, the plugin is updated and the new key is remembered.',
  ...
  'admin.plugins.security.trustBody':
    'Installing a plugin is like installing any third-party app: only add code from authors you trust, and when in doubt, inspect it yourself first. moon takes no responsibility for third-party plugins.',
  ...
  'admin.plugins.dep.moonIncompatible': 'Needs moon {range} — this server runs {host}',
  'admin.plugins.dep.moonUnknown': 'Does not say which moon versions it supports',
  ...
  'admin.addons.subtitle': 'Enable or disable features to customize your moon experience.',
  ...
  'admin.weather.description':
    'moon uses Open-Meteo as its weather data source. Open-Meteo is a free, open-source weather service — no API key required.',
  ...
  'admin.github.by': 'by',
  'admin.github.support': 'Helps me keep building moon',
  'admin.update.available': 'Update available',
  'admin.update.text': 'moon {version} is available. You are running {current}.',
  'admin.update.button': 'View on GitHub',
  'admin.update.install': 'Install Update',
  'admin.update.confirmTitle': 'Install Update?',
  'admin.update.confirmText':
    'moon will be updated from {current} to {version}. The server will restart automatically afterwards.',
  ...
  'admin.update.dockerText':
    'Your moon instance runs in Docker. To update to {version}, run the following commands on your server:',
  'admin.update.nonDockerText':
    'This moon instance is not running in Docker. To update to {version}, re-run the install or update method you used — for example, on Proxmox Community Scripts run the update from the LXC console:',
  ...
  'admin.passkey.rpIdHint':
    'The bare domain passkeys are bound to, e.g. moon.example.org. Leave empty to derive it from APP_URL. Changing it later invalidates existing passkeys.',
  'admin.passkey.origins': 'Allowed origins',
  'admin.passkey.originsHint':
    'Comma-separated full origins, e.g. https://moon.example.org. Leave empty to use APP_URL.',
