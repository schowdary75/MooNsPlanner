...
const settings: TranslationStrings = {
  ...
  'settings.about.supporters.title': 'Travel companions for moon',
  ...
  'settings.about.description':
    'moon is a self-hosted travel planner that helps you organize your trips from the first idea to the last memory. Day planning, budget, packing lists, photos and much more — all in one place, on your own server.',
  'settings.about.madeWith': 'Made with',
  'settings.about.madeBy': 'by MooN and a growing open-source community.',
  ...
  'settings.airtrail.writeBackHint':
    'Off by default: AirTrail is the source of truth and moon only reads from it. Turn on to push edits made in moon back to AirTrail.',
