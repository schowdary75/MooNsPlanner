...
const system_notice: TranslationStrings = {
  ...
  'system_notice.v3_mcp.body':
    'The MCP integration has been fully overhauled. OAuth 2.1 is now the recommended auth method. Legacy static tokens (moon_…) are deprecated and will be removed in a future release.',
  ...
  'system_notice.v3_mcp.highlight_deprecated': 'Static moon_ tokens deprecated',
  ...
  'system_notice.welcome_v1.title': 'Welcome to moon',
  ...
  'system_notice.welcome_v1.hero_alt': 'A scenic travel destination with moon planning UI overlay',
  ...
  'system_notice.thank_you_support.title': 'Thank you for using moon',
  'system_notice.thank_you_support.body':
    "A quick thank-you for installing moon — it genuinely means a lot.\n\nI'm a solo developer and I build moon in my spare time. It started as a little tool just for my own trips, and I'm honestly blown away by the support and interest from the community since then. moon is made with a lot of heart on my side — but also thanks to the many amazing external contributors who've helped shape it.\n\n**moon is open source and completely free — and it will stay that way forever. No paid tiers, no subscriptions, no catch. I promise.**\n\nIf moon is useful to you and you'd like to support its development, a small coffee genuinely helps me keep building — no pressure at all, but every cup keeps the late nights going.\n\nThank you for being here.\n\n— MooN",
  ...
  'system_notice.thank_you_support.cta_github': 'Support on github.com',
