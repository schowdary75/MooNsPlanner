...
const vacay: TranslationStrings = {
  ...
  'vacay.sharingHint': 'Поділіться планом відпустки з іншими користувачами moon',
  'vacay.owner': 'Власник',
  'vacay.shareEmailPlaceholder': 'Ел. пошта користувача moon',
  ...
  'vacay.inviteHint': 'Запросіть іншого користувача moon для спільного календаря відпусток.',
