...
const admin: TranslationStrings = {
  ...
  'admin.plugins.disabledBody':
    'Середовище виконання плагінів вимкнено (moon_PLUGINS_ENABLED). Жоден плагін не зможе запуститися, доки адміністратор не ввімкне його в конфігурації сервера.',
  ...
  'admin.plugins.requiresmoon': 'Потрібен moon {version}+',
  ...
  'admin.plugins.reviewedMeaning':
    '«Перевірено» означає, що супроводжувач moon перевіряв цей плагін на наявність шкідливого коду в кожній версії — а не на якість чи працездатність. Це не гарантія того, що плагін безпечний.',
  ...
  'admin.plugins.security.permsBody':
    'Дозволи, показані перед встановленням, — це жорстке обмеження, яке moon застосовує під час роботи плагіна: він буквально не може зробити нічого, чого немає у списку. Але вони говорять, що плагін може робити, а не що він насправді робить. Плагін, якому дозволено читати ваші подорожі та звертатися до сервера, може надіслати ваші подорожі на цей сервер, тож читайте дозволи та вихідні хости, а не лише опис.',
  'admin.plugins.security.limitsTitle': 'Чого ми не можемо обіцяти',
  'admin.plugins.security.limitsBody':
    'Ізоляція — це надійна програмна межа, але не абсолютна. Плагін діє рівно з тими правами, які ви схвалили, тож у межах цих прав він може поводитися інакше, ніж описано, і може надсилати дані, якими законно володіє, на заявлені ним хости. moon не читає й не оцінює, що насправді робить код плагіна.',
  ...
  'admin.plugins.security.reviewedBody':
    'Перевірений плагін вручну сканував супроводжувач moon на наявність шкідливого коду в кожній версії — перевіряли на ворожий код, а не на те, чи добре він працює. Це не обіцянка, що плагін безпечний.',
  'admin.plugins.security.signedTitle': 'Що означає «Підписано»',
  'admin.plugins.security.signedBody':
    'Контрольна сума, яку moon перевіряє під час кожного встановлення, доводить, що файли — це саме те, за що ручається реєстр. Підпис доводить інше: що вони походять від автора й підписані ключем, який є лише в нього. Підписаний плагін має і те, і те. Плагін без підпису не є небезпечним — він просто дає на одну гарантію менше, і сьогодні більшість плагінів у реєстрі не підписані.',
  ...
  'admin.plugins.sig.missingBody':
    'Цей плагін був підписаний, коли ви його встановлювали, але нова версія не має підпису. moon не прийме таке пониження мовчки. Це не можна обійти.',
  ...
  'admin.plugins.sig.confirmOutOfBand':
    'moon не може відрізнити законну зміну ключа від захоплення — звідси вони виглядають однаково. Перш ніж прийняти новий ключ, підтвердьте його в автора через канал, якому ви вже довіряєте. Щойно ви це зробите, плагін буде оновлено, а новий ключ — збережено.',
  ...
  'admin.plugins.security.trustBody':
    'Встановлення плагіна — це те саме, що встановлення будь-якого стороннього застосунку: додавайте лише код від авторів, яким довіряєте, а в разі сумнівів спершу перевірте його самостійно. moon не несе відповідальності за сторонні плагіни.',
  ...
  'admin.plugins.dep.moonIncompatible': 'Потрібен moon {range} — на цьому сервері {host}',
  'admin.plugins.dep.moonUnknown': 'Не вказано, які версії moon підтримуються',
  ...
  'admin.addons.subtitle': 'Увімкніть або вимкніть функції, щоб налаштувати moon під себе.',
  ...
  'admin.weather.description':
    'moon використовує Open-Meteo як джерело даних про погоду. Open-Meteo — безкоштовний сервіс з відкритим кодом, API-ключ не потрібен.',
  ...
  'admin.github.support': 'Допомагає продовжувати розробку moon',
  'admin.github.error': 'Не вдалося завантажити релізи',
  'admin.github.by': 'від',
  'admin.update.available': 'Доступне оновлення',
  'admin.update.text': 'Доступна версія moon {version}. У вас встановлено {current}.',
  ...
  'admin.update.confirmText': 'moon буде оновлено з {current} до {version}. Сервер перезапуститься автоматично.',
  ...
  'admin.update.dockerText':
    'Ваш екземпляр moon працює в Docker. Для оновлення до {version} виконайте ці команди на сервері:',
  'admin.update.nonDockerText':
    'Цей екземпляр moon не працює в Docker. Щоб оновити до {version}, повторно запустіть метод встановлення або оновлення, який ви використовували, — наприклад, у Proxmox Community Scripts запустіть оновлення з консолі LXC:',
  ...
  'admin.passkey.rpIdHint':
    'Чистий домен, до якого прив’язані passkeys, напр. moon.example.org. Залиште порожнім, щоб визначити його з APP_URL. Подальша зміна робить наявні passkeys недійсними.',
  'admin.passkey.origins': 'Дозволені джерела (origins)',
  'admin.passkey.originsHint':
    'Повні джерела через кому, напр. https://moon.example.org. Залиште порожнім, щоб використати APP_URL.',
