...
const settings: TranslationStrings = {
  ...
  'settings.about.supporters.title': 'Resekompisar för moon',
  'settings.about.supporters.subtitle':
    'Medan du planerar din nästa rutt bidrar dessa personer till att forma moon:s framtid. Deras månatliga bidrag går direkt till utveckling och faktisk arbetstid – så att moon förblir öppen källkod.',
  ...
  'settings.about.description':
    'moon är en resplanerare som du själv kan driva och som hjälper dig att organisera dina resor från den första idén till det sista minnet. Dagsplanering, budget, packlistor, foton och mycket mer – allt på ett och samma ställe, på din egen server.',
  'settings.about.madeWith': 'Gjord med',
  'settings.about.madeBy': 'av MooN och en växande open source-gemenskap.',
  ...
  'settings.airtrail.writeBackHint':
    'Avstängt som standard: AirTrail är den primära källan och moon läser endast från den. Aktivera funktionen för att skicka ändringar som gjorts i moon tillbaka till AirTrail.',
