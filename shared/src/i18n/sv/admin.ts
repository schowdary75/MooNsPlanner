...
const admin: TranslationStrings = {
  ...
  'admin.plugins.disabledBody':
    'Plugin-körmiljön är avstängd (moon_PLUGINS_ENABLED). Inga plugins kan köras förrän en administratör aktiverar den i serverkonfigurationen.',
  ...
  'admin.plugins.requiresmoon': 'Kräver moon {version}+',
  ...
  'admin.plugins.reviewedMeaning':
    '”Granskad” betyder att en moon-underhållare har skannat pluginet efter skadlig kod i varje version — inte efter kvalitet eller om det fungerar. Det är ingen garanti för att ett plugin är ofarligt.',
  ...
  'admin.plugins.sig.missingBody':
    'Det här pluginet var signerat när du installerade det, men den nya versionen levereras utan signatur. moon accepterar inte den försämringen i tysthet. Detta går inte att förbigå.',
  ...
  'admin.plugins.sig.confirmOutOfBand':
    'moon kan inte skilja ett legitimt nyckelbyte från en kapning — härifrån ser de identiska ut. Bekräfta den nya nyckeln med upphovspersonen via en kanal du redan litar på innan du accepterar den. När du gör det uppdateras pluginet och den nya nyckeln sparas.',
  ...
  'admin.plugins.security.trustBody':
    'Att installera ett plugin är som att installera vilken tredjepartsapp som helst: lägg bara till kod från upphovspersoner du litar på, och granska det själv först om du är osäker. moon tar inget ansvar för tredjepartsplugins.',
  ...
  'admin.plugins.dep.moonIncompatible': 'Kräver moon {range} — den här servern kör {host}',
  'admin.plugins.dep.moonUnknown': 'Anger inte vilka moon-versioner som stöds',
  ...
  'admin.addons.subtitle': 'Aktivera eller inaktivera funktioner för att anpassa din moon-upplevelse.',
  ...
  'admin.weather.description':
    'moon använder Open-Meteo som källa för väderdata. Open-Meteo är en kostnadsfri vädertjänst med öppen källkod – ingen API-nyckel krävs.',
  ...
  'admin.github.by': 'av',
  'admin.github.support': 'Hjälper mig att fortsätta bygga moon',
  'admin.update.available': 'Uppdatering tillgänglig',
  'admin.update.text': 'moon {version} finns tillgängligt. Du kör {current}.',
  ...
  'admin.update.confirmText':
    'moon kommer att uppdateras från {current} till {version}. Servern startas om automatiskt därefter.',
  ...
  'admin.update.dockerText':
    'Din moon-instans körs i Docker. För att uppdatera till {version} kör du följande kommandon på din server:',
  'admin.update.nonDockerText':
    'Denna moon-instans körs inte i Docker. För att uppdatera till {version}, kör installations- eller uppdateringsmetod du använde på nytt — till exempel, i Proxmox Community Scripts kör du uppdateringen från LXC-konsolen:',
  ...
  'admin.passkey.rpIdHint':
    'De rena domän inloggningsnycklarna är kopplade till t.ex. moon.example.org. Lämna fältet tomt om du vill att nyckeln ska härledas från APP_URL. Om du ändrar detta senare blir befintliga nycklar ogiltiga.',
  'admin.passkey.origins': 'Allowed origins',
  'admin.passkey.originsHint':
    'Fullständiga ursprungsadresser separerade med kommatecken, t.ex. https://moon.example.org. Lämna fältet tomt för att använda APP_URL.',
