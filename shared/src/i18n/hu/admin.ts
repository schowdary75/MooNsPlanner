...
const admin: TranslationStrings = {
  ...
  'admin.plugins.disabledBody':
    'A plugin futtatókörnyezet ki van kapcsolva (moon_PLUGINS_ENABLED). Egyetlen plugin sem futhat, amíg egy admin nem engedélyezi a szerverkonfigurációban.',
  ...
  'admin.plugins.requiresmoon': 'moon {version}+ szükséges',
  ...
  'admin.plugins.reviewedMeaning':
    'Az „Ellenőrizve" azt jelenti, hogy egy moon karbantartó minden verziónál átvizsgálta ezt a plugint kártevők után — nem a minőségét vagy azt, hogy működik-e. Ez nem garancia arra, hogy a plugin ártalmatlan.',
  ...
  'admin.plugins.sig.missingBody':
    'Ez a plugin alá volt írva, amikor telepítetted, de az új verzió nem tartalmaz aláírást. A moon nem fogadja el csendben ezt a visszalépést. Ez nem hagyható figyelmen kívül.',
  ...
  'admin.plugins.sig.confirmOutOfBand':
    'A moon nem tudja megkülönböztetni a jogos kulcscserét az átvételtől — innen nézve a kettő azonos. Erősítsd meg az új kulcsot a szerzőnél egy olyan csatornán, amelyben már megbízol, mielőtt elfogadod. Amint ezt megteszed, a plugin frissül, és a moon megjegyzi az új kulcsot.',
  ...
  'admin.plugins.security.trustBody':
    'Egy plugin telepítése olyan, mint bármely harmadik féltől származó alkalmazás telepítése: csak megbízható szerzőktől adj hozzá kódot, és kétség esetén előbb magad vizsgáld meg. A moon semmilyen felelősséget nem vállal a harmadik féltől származó pluginokért.',
  ...
  'admin.plugins.dep.moonIncompatible': 'moon {range} szükséges — ez a kiszolgáló {host} verziót futtat',
  'admin.plugins.dep.moonUnknown': 'Nem adja meg, mely moon-verziókat támogatja',
  ...
  'admin.addons.subtitle': 'Funkciók engedélyezése vagy letiltása a moon testreszabásához.',
  ...
  'admin.weather.description':
    'A moon az Open-Meteo-t használja időjárás-adatforrásként. Az Open-Meteo egy ingyenes, nyílt forráskódú időjárás-szolgáltatás — nincs szükség API kulcsra.',
  ...
  'admin.github.support': 'Segít fenntartani a moon fejlesztését',
  'admin.update.available': 'Frissítés elérhető',
  'admin.update.text': 'A moon {version} elérhető. Jelenleg a {current} verziót használod.',
  ...
  'admin.update.confirmText':
    'A moon frissítésre kerül {current} verzióról {version} verzióra. A szerver ezután automatikusan újraindul.',
  ...
  'admin.update.dockerText':
    'A moon példányod Dockerben fut. A {version} verzióra frissítéshez futtasd a következő parancsokat a szervereden:',
  'admin.update.nonDockerText':
    'Ez a moon példány nem Dockerben fut. A {version} verzióra frissítéshez futtasd újra a telepítési vagy frissítési módszert, amelyet használtál — például Proxmox Community Scripts esetén futtasd a frissítést az LXC konzolból:',
  ...
  'admin.passkey.rpIdHint':
    'A csupasz domain, amelyhez a passkey-k kötődnek, pl. moon.example.org. Hagyd üresen, hogy az APP_URL-ből legyen levezetve. Későbbi módosítása érvényteleníti a meglévő passkey-ket.',
  'admin.passkey.origins': 'Engedélyezett origók',
  'admin.passkey.originsHint':
    'Vesszővel elválasztott teljes origók, pl. https://moon.example.org. Hagyd üresen az APP_URL használatához.',
