...
const settings: TranslationStrings = {
  ...
  'settings.about.supporters.title': 'Útitársak a moon mellett',
  'settings.about.supporters.subtitle':
    'Miközben te a következő útvonaladat tervezed, ők a moon jövőjét tervezik velem együtt. Havi hozzájárulásuk közvetlenül fejlesztésre és valódi órákra fordítódik — hogy a moon Open Source maradhasson.',
  ...
  'settings.about.description':
    'A moon egy saját szerveren üzemeltetett útitervező, amely segít az utazásaid megszervezésében az első ötlettől az utolsó emlékig. Napi tervezés, költségvetés, csomagolási listák, fotók és még sok más — minden egy helyen, a saját szervereden.',
  'settings.about.madeWith': 'Készítve',
  'settings.about.madeBy': 'MooN és egy növekvő nyílt forráskódú közösség által.',
  ...
  'settings.airtrail.writeBackHint':
    'Alapértelmezés szerint kikapcsolva: az AirTrail a hiteles forrás, és a moon csak olvas belőle. Kapcsold be, hogy a moon-ben végzett módosításokat visszaküldje az AirTrailbe.',
