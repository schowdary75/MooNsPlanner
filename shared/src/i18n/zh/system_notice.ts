...
const system_notice: TranslationStrings = {
  ...
  'system_notice.thank_you_support.title': '感谢你使用 moon',
  'system_notice.thank_you_support.body':
    '想跟你说声谢谢——谢谢你安装了 moon，这对我来说真的意义非凡。\n\n我是一名独立开发者，moon 是我利用业余时间打造的。它最初只是我为自己的旅行做的一个小工具，而社区一路以来给予的支持和关注，老实说让我感到无比惊喜。moon 是我用满满的热爱做出来的——但也离不开许多了不起的外部贡献者，是他们一起塑造了今天的它。\n\n**moon 是开源的，完全免费——而且永远都会如此。没有付费档位，没有订阅，没有任何套路。我保证。**\n\n如果 moon 对你有帮助，并且你愿意支持它的开发，请我喝一杯小小的咖啡，真的能帮我把它继续做下去——完全没有任何压力，但每一杯都让那些挑灯夜战的夜晚有了坚持的动力。\n\n谢谢你来到这里。\n\n— MooN',
  ...
  'system_notice.thank_you_support.cta_github': '在 github.com 上支持',
  ...
  'system_notice.v3_photos.body':
    '旅行规划器中的​**照片**标签已被移除。您的照片安全无虑 — moon 从未修改您的 Immich 或 Synology 相册。\n\n照片现在位于 **旅程** 插件中。旅程是可选的 — 如果尚未启用，请联系管理员在 Admin → 插件 中开启。',
  ...
  'system_notice.v3_mcp.body':
    'MCP 集成已全面重构。OAuth 2.1 现为推荐的身份验证方式。静态令牌（moon_…）已弃用，将在未来版本中移除。',
  'system_notice.v3_mcp.highlight_oauth': 'OAuth 2.1 推荐（mcp-remote）',
  'system_notice.v3_mcp.highlight_scopes': '24 个细粒度权限范围',
  'system_notice.v3_mcp.highlight_deprecated': '静态 moon_ 令牌已弃用',
  'system_notice.v3_mcp.highlight_tools': '扩展工具集与提示词',
  'system_notice.v3_thankyou.title': '来自我的一封私人信',
  'system_notice.v3_thankyou.body':
    '在你继续之前——我想停下来说几句。\n\nmoon 最初只是我为自己的旅行而做的一个业余项目。我从未想过它会成长为 4,000 人信赖的冒险规划工具。每一颗星标、每一个 issue、每一个功能请求——我都会读，它们在全职工作和大学学业之间的深夜里支撑着我继续前行。\n\n我想让你们知道：moon 将永远开源，永远可自托管，永远属于你们。没有追踪，没有订阅，没有任何附加条件。只是一个热爱旅行的人为同样热爱旅行的你们打造的工具。\n\n特别感谢 [MooN](https://github.com/MooN)——你已经成为一位不可思议的合作者。3.0 版本中许多精彩之处都留下了你的印记。感谢你在这个项目还很粗糙的时候就选择了相信它。\n\n也感谢你们每一位——报告了 bug、翻译了文本、向朋友分享了 moon，或者只是用它规划了一次旅行——**谢谢你们**。你们是这一切存在的原因。\n\n愿我们一起踏上更多的冒险旅程。\n\n— MooN\n\n---\n\n[加入 Discord 社区](https://discord.gg/7Q6M6jDwzf)\n\n如果 moon 让你的旅行更美好，一杯[小小的咖啡](https://github.com/schowdary75)能让这盏灯一直亮着。',
