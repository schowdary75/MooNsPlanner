...
const vacay: TranslationStrings = {
  ...
  'vacay.sharingHint': 'Compartilhe seu plano de férias com outros usuários do moon',
  'vacay.owner': 'Proprietário',
  'vacay.shareEmailPlaceholder': 'E-mail do usuário moon',
  ...
  'vacay.inviteHint': 'Convide outro usuário moon para compartilhar um calendário de férias combinado.',
