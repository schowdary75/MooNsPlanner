...
const admin: TranslationStrings = {
  ...
  'admin.plugins.disabledBody':
    'O runtime de plugins está desligado (moon_PLUGINS_ENABLED). Nenhum plugin pode ser executado até que um admin o ative na configuração do servidor.',
  ...
  'admin.plugins.requiresmoon': 'Requer moon {version}+',
  ...
  'admin.plugins.reviewedMeaning':
    '"Revisado" significa que um mantenedor do moon verificou este plugin em busca de malware em cada versão — não quanto à qualidade ou se ele funciona. Não é garantia de que um plugin seja inofensivo.',
  ...
  'admin.plugins.sig.missingBody':
    'Este plugin estava assinado quando você o instalou, mas a nova versão não traz assinatura alguma. O moon não vai aceitar essa perda em silêncio. Isso não pode ser ignorado.',
  ...
  'admin.plugins.sig.confirmOutOfBand':
    'O moon não consegue distinguir uma troca legítima de chave de um sequestro do plugin — daqui, as duas coisas são idênticas. Confirme a nova chave com o autor por um canal em que você já confia antes de aceitá-la. Assim que aceitar, o plugin é atualizado e a nova chave passa a ser lembrada.',
  ...
  'admin.plugins.security.trustBody':
    'Instalar um plugin é como instalar qualquer app de terceiros: adicione apenas código de autores em quem você confia e, em caso de dúvida, inspecione-o você mesmo antes. O moon não assume nenhuma responsabilidade por plugins de terceiros.',
  ...
  'admin.plugins.dep.moonIncompatible': 'Requer moon {range} — este servidor executa {host}',
  'admin.plugins.dep.moonUnknown': 'Não informa quais versões do moon são compatíveis',
  ...
  'admin.addons.subtitle': 'Ative ou desative recursos para personalizar sua experiência no moon.',
  ...
  'admin.weather.description':
    'O moon usa Open-Meteo como fonte de clima. Open-Meteo é um serviço gratuito e de código aberto — sem chave de API.',
  ...
  'admin.github.by': 'por',
  'admin.github.support': 'Ajuda a continuar desenvolvendo o moon',
  'admin.update.available': 'Atualização disponível',
  'admin.update.text': 'O moon {version} está disponível. Você está na {current}.',
  ...
  'admin.update.confirmText':
    'O moon será atualizado de {current} para {version}. O servidor reiniciará automaticamente em seguida.',
  ...
  'admin.update.dockerText': 'Sua instância moon roda no Docker. Para atualizar para {version}, execute no servidor:',
  'admin.update.nonDockerText':
    'Esta instância do moon não está rodando no Docker. Para atualizar para {version}, execute novamente o método de instalação ou atualização que você usou — por exemplo, no Proxmox Community Scripts, execute a atualização a partir do console do LXC:',
  ...
  'admin.passkey.rpIdHint':
    'O domínio puro ao qual as passkeys ficam vinculadas, ex.: moon.example.org. Deixe vazio para derivá-lo de APP_URL. Alterá-lo depois invalida as passkeys existentes.',
  'admin.passkey.origins': 'Origens permitidas',
  'admin.passkey.originsHint':
    'Origens completas separadas por vírgula, ex.: https://moon.example.org. Deixe vazio para usar APP_URL.',
