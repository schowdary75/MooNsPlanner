...
const system_notice: TranslationStrings = {
  'system_notice.welcome_v1.title': 'Bem-vindo ao moon',
  ...
  'system_notice.welcome_v1.hero_alt': 'Destino de viagem pitoresco com a interface do moon',
  ...
  'system_notice.thank_you_support.title': 'Obrigado por usar o moon',
  'system_notice.thank_you_support.body':
    'Um obrigado rápido por instalar o moon — isso significa muito para mim, de verdade.\n\nSou um desenvolvedor solo e construo o moon no meu tempo livre. Tudo começou como uma ferramentinha só para as minhas próprias viagens, e confesso que fico maravilhado com o apoio e o interesse da comunidade desde então. O moon é feito com muito carinho da minha parte — mas também graças aos muitos colaboradores externos incríveis que ajudaram a moldá-lo.\n\n**O moon é open source e totalmente gratuito — e vai continuar assim para sempre. Sem planos pagos, sem assinaturas, sem pegadinhas. Eu prometo.**\n\nSe o moon é útil para você e você quiser apoiar o seu desenvolvimento, um cafezinho ajuda muito a me manter construindo — sem nenhuma pressão, mas cada xícara mantém as noites longas em pé.\n\nObrigado por estar aqui.\n\n— MooN',
  ...
  'system_notice.thank_you_support.cta_github': 'Apoiar no github.com',
  ...
  'system_notice.v3_mcp.body':
    'A integração MCP foi completamente reformulada. OAuth 2.1 agora é o método de autenticação recomendado. Tokens estáticos (moon_…) foram descontinuados e serão removidos em uma versão futura.',
  ...
  'system_notice.v3_mcp.highlight_deprecated': 'Tokens estáticos moon_ descontinuados',
  ...
  'system_notice.v3_thankyou.body':
    'Antes de seguir em frente — quero fazer uma pausa.\n\nO moon começou como um projeto paralelo que criei para minhas próprias viagens. Nunca imaginei que cresceria a ponto de 4.000 de vocês confiarem nele para planejar suas aventuras. Cada estrela, cada issue, cada pedido de recurso — eu leio todos, e eles me mantêm firme nas noites longas entre um trabalho em tempo integral e a universidade.\n\nQuero que saibam: o moon sempre será open source, sempre self-hosted, sempre de vocês. Sem rastreamento, sem assinaturas, sem pegadinhas. Apenas uma ferramenta feita por alguém que ama viajar tanto quanto vocês.\n\nAgradecimento especial ao [MooN](https://github.com/MooN) — você se tornou um colaborador incrível. Muito do que torna a versão 3.0 especial tem a sua marca. Obrigado por acreditar neste projeto quando ele ainda era bem cru.\n\nE a cada um de vocês que reportou um bug, traduziu uma string, compartilhou o moon com um amigo ou simplesmente o usou para planejar uma viagem — **obrigado**. Vocês são a razão de tudo isso existir.\n\nQue venham muitas mais aventuras juntos.\n\n— MooN\n\n---\n\n[Junte-se à comunidade no Discord](https://discord.gg/7Q6M6jDwzf)\n\nSe o moon torna suas viagens melhores, um [cafezinho](https://github.com/schowdary75) sempre mantém as luzes acesas.',
