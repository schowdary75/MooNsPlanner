...
const system_notice: TranslationStrings = {
  'system_notice.welcome_v1.title': 'Добро пожаловать в moon',
  ...
  'system_notice.welcome_v1.hero_alt': 'Живописное место назначения с интерфейсом moon',
  ...
  'system_notice.thank_you_support.title': 'Спасибо, что выбрали moon',
  'system_notice.thank_you_support.body':
    'Небольшое спасибо за то, что установили moon — для меня это правда очень много значит.\n\nЯ разработчик-одиночка и делаю moon в свободное время. Всё началось как маленький инструмент для моих собственных поездок, и я, честно говоря, поражён той поддержкой и интересом, которые проявило сообщество с тех пор. moon создаётся с большой любовью с моей стороны — но также благодаря множеству замечательных внешних участников, которые помогли его сформировать.\n\n**moon — это открытый исходный код и полностью бесплатно — и так будет всегда. Никаких платных тарифов, никаких подписок, никаких подвохов. Обещаю.**\n\nЕсли moon вам полезен и вы хотите поддержать его развитие, маленький кофе по-настоящему помогает мне продолжать — без всякого давления, но каждая чашка даёт силы для поздних ночей.\n\nСпасибо, что вы здесь.\n\n— MooN',
  ...
  'system_notice.thank_you_support.cta_github': 'Поддержать на github.com',
  ...
  'system_notice.v3_mcp.body':
    'Интеграция MCP была полностью переработана. OAuth 2.1 теперь является рекомендуемым методом аутентификации. Статические токены (moon_…) устарели и будут удалены в будущей версии.',
  ...
  'system_notice.v3_mcp.highlight_deprecated': 'Статические токены moon_ устарели',
  ...
  'system_notice.v3_thankyou.body':
    'Прежде чем продолжить — хочу остановиться на мгновение.\n\nmoon начинался как сторонний проект, который я создал для собственных поездок. Я никогда не думал, что он вырастет во что-то, чему 4 000 из вас доверяют планирование своих приключений. Каждая звёздочка, каждый issue, каждый запрос на фичу — я читаю их все, и именно они поддерживают меня в поздние ночи между основной работой и университетом.\n\nХочу, чтобы вы знали: moon всегда будет open source, всегда self-hosted, всегда вашим. Никакого отслеживания, никаких подписок, никаких подвохов. Просто инструмент, созданный человеком, который любит путешествовать так же, как и вы.\n\nОсобая благодарность [MooN](https://github.com/MooN) — ты стал невероятным соратником. Многое из того, что делает версию 3.0 великолепной, несёт твой отпечаток. Спасибо, что поверил в этот проект, когда он был ещё сырым.\n\nИ каждому из вас, кто сообщил об ошибке, перевёл строку, поделился moon с другом или просто использовал его для планирования поездки — **спасибо**. Вы — причина, по которой всё это существует.\n\nЗа множество новых приключений вместе.\n\n— MooN\n\n---\n\n[Присоединяйся к сообществу в Discord](https://discord.gg/7Q6M6jDwzf)\n\nЕсли moon делает твои путешествия лучше, [маленький кофе](https://github.com/schowdary75) всегда помогает держать свет включённым.',
