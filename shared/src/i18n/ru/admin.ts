...
const admin: TranslationStrings = {
  ...
  'admin.plugins.disabledBody':
    'Среда выполнения плагинов выключена (moon_PLUGINS_ENABLED). Плагины не смогут работать, пока администратор не включит её в конфигурации сервера.',
  ...
  'admin.plugins.requiresmoon': 'Требуется moon {version}+',
  ...
  'admin.plugins.reviewedMeaning':
    '«Проверен» означает, что сопровождающий moon проверял этот плагин на вредоносный код в каждой версии — но не его качество или работоспособность. Это не гарантия того, что плагин безвреден.',
  ...
  'admin.plugins.security.reviewedBody':
    'Проверенный плагин был вручную просканирован на вредоносный код сопровождающим moon в каждой версии — проверен на вредоносный код, а не на то, насколько хорошо он работает. Это не обещание того, что плагин безвреден.',
  'admin.plugins.security.signedTitle': 'Что означает «Подписан»',
  'admin.plugins.security.signedBody':
    'Контрольная сумма, которую moon проверяет при каждой установке, доказывает, что файлы — ровно те, за которые ручается реестр. Подпись доказывает другое: что они пришли от автора и подписаны ключом, который есть только у него. У подписанного плагина есть и то, и другое. Неподписанный плагин не является небезопасным — просто у него одной гарантией меньше, и большинство плагинов в реестре сегодня не подписаны.',
  ...
  'admin.plugins.sig.missingBody':
    'Этот плагин был подписан, когда вы его устанавливали, но новая версия поставляется без подписи. moon не примет такой откат молча. Это нельзя обойти.',
  ...
  'admin.plugins.sig.confirmOutOfBand':
    'moon не может отличить законную смену ключа от захвата — отсюда они выглядят одинаково. Прежде чем принять новый ключ, подтвердите его у автора по каналу, которому вы уже доверяете. После этого плагин будет обновлён, а новый ключ — запомнен.',
  ...
  'admin.plugins.security.trustBody':
    'Установка плагина похожа на установку любого стороннего приложения: добавляйте только код от авторов, которым доверяете, а при сомнениях сначала проверьте его самостоятельно. moon не несёт ответственности за сторонние плагины.',
  ...
  'admin.plugins.dep.moonIncompatible': 'Требуется moon {range} — на этом сервере {host}',
  'admin.plugins.dep.moonUnknown': 'Не указано, какие версии moon поддерживаются',
  ...
  'admin.addons.subtitle': 'Включайте или отключайте функции для настройки moon под себя.',
  ...
  'admin.weather.description':
    'moon использует Open-Meteo как источник данных о погоде. Open-Meteo — бесплатный сервис с открытым кодом, API-ключ не требуется.',
  ...
  'admin.github.support': 'Помогает продолжать разработку moon',
  'admin.github.error': 'Не удалось загрузить релизы',
  'admin.github.by': 'от',
  'admin.update.available': 'Доступно обновление',
  'admin.update.text': 'Доступна версия moon {version}. У вас установлена {current}.',
  ...
  'admin.update.confirmText': 'moon будет обновлён с {current} до {version}. Сервер перезапустится автоматически.',
  ...
  'admin.update.dockerText':
    'Ваш экземпляр moon работает в Docker. Для обновления до {version} выполните следующие команды на сервере:',
  'admin.update.nonDockerText':
    'Этот экземпляр moon работает не в Docker. Чтобы обновиться до {version}, повторно запустите способ установки или обновления, который вы использовали, — например, в Proxmox Community Scripts выполните обновление из консоли LXC:',
  ...
  'admin.passkey.rpIdHint':
    'Голый домен, к которому привязаны passkeys, напр. moon.example.org. Оставьте пустым, чтобы определить его из APP_URL. Последующее изменение делает существующие passkeys недействительными.',
  'admin.passkey.origins': 'Разрешённые источники',
  'admin.passkey.originsHint':
    'Полные источники через запятую, напр. https://moon.example.org. Оставьте пустым, чтобы использовать APP_URL.',
