 ...
 *  - DEFAULT_APPEARANCE reproduces moon's current look byte-for-byte, so a user
...
export const APPEARANCE_PRESET_SCHEMES = [
  ...
  'indigo', // moon's classic indigo accent
...
/** The neutral default — must equal moon's current appearance exactly. */
